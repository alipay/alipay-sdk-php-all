...
class AlipayCommerceEcConsumeDetailQueryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['antShopId'] = $data['antShopId'] ?? null;
     ...
     * @return string|null
     */
    public function getAntShopId()
    {
        return $this->container['antShopId'];
    }

    /**
     * Sets antShopId
     *
     * @param string|null $antShopId 蚂蚁门店ID，不可单独用于查询条件，需要配合企业ID和交易号使用
     *
     * @return self
     */
    public function setAntShopId($antShopId)
    {
        $this->container['antShopId'] = $antShopId;
