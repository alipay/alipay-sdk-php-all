...
class PaidOuterCardCycleInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets closeReason
     *
     * @param string|null $closeReason 关闭连续购买原因。枚举如下： MANUAL_CLOSE(手动关闭) EXPIRE_CLOSE(过期关闭) CLOSE(关闭)
     *
     * @return self
     */
     ...
     * Sets cycleType
     *
     * @param string|null $cycleType 用户开通连续购买类型。枚举如下： YEAR(年) QUARTER(季度) MONTH(月)
     *
     * @return self
     */
     ...
     * Sets openStatus
     *
     * @param string|null $openStatus 开通连续购买状态。枚举如下： OPEN(打开) CLOSE(关闭)
     *
     * @return self
     */
