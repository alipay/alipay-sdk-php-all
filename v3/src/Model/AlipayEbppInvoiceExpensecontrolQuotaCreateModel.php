...
class AlipayEbppInvoiceExpensecontrolQuotaCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $effectiveEndDate 额度失效时间（格式：yyyy-MM-dd HH:mm:ss），额度类型为点券时必填，额度类型为余额时有默认值，无需填写
     *
     * @return self
     */
     ...
     *
     * @param string|null $effectiveStartDate 额度生效时间（格式：yyyy-MM-dd HH:mm:ss），额度类型为点券时必填，额度类型为余额时有默认值，无需填写
     *
     * @return self
     */
     ...
     * Sets outerSourceId
     *
     * @param string|null $outerSourceId 外部操作幂等ID（接入方接口调用幂等控制ID），创建额度类型为点券时必填
     *
     * @return self
     */
     ...
     * Sets ownerId
     *
     * @param string|null $ownerId 额度所属者ID（未切换open_id请使用此字段）： owner_type为EMPLOYEE时填写员工支付宝ID； owner_type为ENTERPRISE_PAY_UID时填写员工企业码ID； owner_type为PHONE时填写员工手机号； owner_type为ENTERPRISE时填写企业ID。
     *
     * @return self
     */
     ...
     * Sets ownerOpenId
     *
     * @param string|null $ownerOpenId 额度所属者ID（切换open_id后请使用此字段）： owner_type为EMPLOYEE时填写open_id； owner_type为ENTERPRISE_PAY_UID时填写员工企业码ID； owner_type为PHONE时填写员工手机号； owner_type为ENTERPRISE时填写企业ID。
     *
     * @return self
     */
     ...
     * Sets ownerType
     *
     * @param string|null $ownerType 额度所属者类型，可通过设置该字段来指定操作的owner_id类型，如果设置企业额度则设置为ENTERPRISE
     *
     * @return self
     */
     ...
     * Sets quotaType
     *
     * @param string|null $quotaType 创建额度类型，支持点券和余额，不填写则默认为余额类型
     *
     * @return self
     */
     ...
     * Sets quotaValue
     *
     * @param string|null $quotaValue 额度值，以（分）为单位 约束：个人额度不超过100000元，企业额度不超过100000000元
     *
     * @return self
     */
     ...
     * Sets shareMode
     *
     * @param string|null $shareMode 0:不可转赠（注：不传模式为0） 1:可以转增（注：只有quota_type=COUPON,可设置）
     *
     * @return self
     */
