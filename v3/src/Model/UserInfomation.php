...
class UserInfomation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets certType
     *
     * @param string|null $certType 身份证：IDENTITY_CARD、护照：PASSPORT、军官证：OFFICER_CARD、士兵证：SOLDIER_CARD、户口本：HOKOU等。
     *
     * @return self
     */
     ...
     * Sets openId
     *
     * @param string|null $openId 用户（user_id）在应用（appId）下的唯一用户标识
     *
     * @return self
     */
