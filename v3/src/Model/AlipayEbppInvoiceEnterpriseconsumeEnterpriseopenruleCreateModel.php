...
class AlipayEbppInvoiceEnterpriseconsumeEnterpriseopenruleCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets agreementNo
     *
     * @param string|null $agreementNo 授权签约协议号（仅使用account_id时必传）
     *
     * @return self
     */
     ...
     * Sets billMonthDay
     *
     * @param int|null $billMonthDay 账期结束日期，可选范围1-31，只有汇总开需要
     *
     * @return self
     */
     ...
     * Sets invoiceTitleId
     *
     * @param string|null $invoiceTitleId 汇总开需要抬头，笔笔开不需要传抬头
     *
     * @return self
     */
     ...
     * Sets sellerType
     *
     * @param string|null $sellerType 销方类型：TP开票、商户开票， 枚举定义：MERCHANT（商户）、TP（TP），不填默认商户
     *
     * @return self
     */
