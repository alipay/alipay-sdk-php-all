...
class AlipayEbppInvoiceInstitutionModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets accountId
     *
     * @param string|null $accountId 企业共同账户id（条件必填）
     *
     * @return self
     */
     ...
     * Sets agreementNo
     *
     * @param string|null $agreementNo 授权签约协议号（条件必填）
     *
     * @return self
     */
     ...
     * Sets effective
     *
     * @param string|null $effective 制度是否启用（可空），\"0\"为停用，\"1\"为启用
     *
     * @return self
     */
     ...
     *
     * @param string|null $effectiveStartDate 制度生效起始时间（可空），最小粒度为天，最早是当日
     *
     * @return self
     */
     ...
     *
     * @param string|null $institutionName 制度名称（可空）
     *
     * @return self
     */
