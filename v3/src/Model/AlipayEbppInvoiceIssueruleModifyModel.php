...
class AlipayEbppInvoiceIssueruleModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets effective
     *
     * @param string|null $effective 是否启用，\"0\"为停用，\"1\"为启用； 如果target_type指定INSTITUTION，则与制度一致
     *
     * @return self
     */
     ...
     * Sets invalidMode
     *
     * @param int|null $invalidMode 是否可累计（不传则不修改），枚举：0（不可累计）、1（可累计），默认为0，余额只允许可累计，按城市发放只允许不可累计，设置了生效周期只允许不可累计
     *
     * @return self
     */
     ...
     *
     * @param string|null $issueAmountValue 发放金额（不传则不修改）； 按城市不同发放标准示例值：\"[{\\\"cities\\\":[\\\"321000\\\",\\\"321100\\\"],\\\"amount\\\":\\\"50\\\"},{\\\"cities\\\":[\\\"321200\\\",\\\"321300\\\"],\\\"amount\\\":\\\"150\\\"}]\" 统一标准发放示例值：\"200\"
     *
     * @return self
     */
     ...
     * Sets issueStartDate
     *
     * @param string|null $issueStartDate 发放规则的开始时间 如果target_type指定INSTITUTION，则使用制度有效期起始时间，不支持修改
     *
     * @return self
     */
     ...
     * Sets issueType
     *
     * @param string|null $issueType 发放类型（不传则不修改），枚举：ISSUE_MONTH（按月发放）、ISSUE_DAY（按日发放）
     *
     * @return self
     */
     ...
     * Sets quotaType
     *
     * @param string|null $quotaType 额度类型（不传则不修改），枚举：COUPON（点券）、CAP（余额）
     *
     * @return self
     */
     ...
     * Sets shareMode
     *
     * @param int|null $shareMode 是否可转赠（不传则不修改），枚举：0（不可转赠）、1（可转赠），默认为0，余额不支持可转赠，按城市发放不支持可转赠
     *
     * @return self
     */
     ...
     * Sets targetType
     *
     * @param string|null $targetType 发放规则关联的目标类型，枚举值：INSTITUTION(制度)
     *
     * @return self
     */
