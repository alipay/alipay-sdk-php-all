...
class AntMerchantExpandShopConsultModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets certImage
     *
     * @param string|null $certImage 营业执照图片，需传入<a href=\"https://opendocs.alipay.com/apis/api_1/ant.merchant.expand.indirect.image.upload\">ant.merchant.expand.indirect.image.upload</a> 接口上传图片后得到的 image_id。 注意： * 蚂蚁门店管理场景可选。 * 间连 M1、M2商家创建门店，必须传入营业执照图片。
     *
     * @return self
     */
     ...
     * Sets certNo
     *
     * @param string|null $certNo 证件号码，请填写店铺营业执照号。 注意： * 蚂蚁门店管理场景可选。 * 间连 M1、M2商家创建门店，必须传入营业执照号。
     *
     * @return self
     */
     ...
     * Sets legalCertNo
     *
     * @param string|null $legalCertNo 法人身份证号。蚂蚁门店管理场景可选。
     *
     * @return self
     */
     ...
     * Sets legalName
     *
     * @param string|null $legalName 法人名称。蚂蚁门店管理场景可选。
     *
     * @return self
     */
     ...
     * Sets outDoorImages
     *
     * @param string|null $outDoorImages 门头照 id，需传入 <a href=\"https://opendocs.alipay.com/apis/api_1/ant.merchant.expand.indirect.image.upload\">ant.merchant.expand.indirect.image.upload</a> 接口上传图片后得到的 image_id。 蚂蚁门店管理场景可选。
     *
     * @return self
     */
