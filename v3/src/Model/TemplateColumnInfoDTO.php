...
class TemplateColumnInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets iconId
     *
     * @param string|null $iconId 若template_style_info.column_info_layout  的值为grid，此项为宫格项的展示icon。通过接口（alipay.offline.material.image.upload）上传图片。
     *
     * @return self
     */
     ...
     * Sets tag
     *
     * @param string|null $tag 若template_style_info.column_info_layout  的值为grid，此项为宫格项标签。可空。
     *
     * @return self
     */
