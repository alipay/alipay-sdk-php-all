...
class AntMerchantExpandShopCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'memo' => 'string',
        'newBusinessTime' => '\Alipay\OpenAPISDK\Model\ComplexBusinessTime[]',
    ...
    protected static $attributeMap = [
        ...
        'certName' => 'cert_name',
        'certNo' => 'cert_no',
        'certStartExpireTime' => 'cert_start_expire_time',
        'certType' => 'cert_type',
        ...
        'extInfos' => 'ext_infos',
        'fundProofs' => 'fund_proofs',
        'fundType' => 'fund_type',
        'identityBackUrl' => 'identity_back_url',
        'identityEndTime' => 'identity_end_time',
        'identityFrontUrl' => 'identity_front_url',
    ...
    protected static $setters = [
        ...
        'certNo' => 'setCertNo',
        'certStartExpireTime' => 'setCertStartExpireTime',
        ...
        'fundProofs' => 'setFundProofs',
        'fundType' => 'setFundType',
        'identityBackUrl' => 'setIdentityBackUrl',
        'identityEndTime' => 'setIdentityEndTime',
        'identityFrontUrl' => 'setIdentityFrontUrl',
        'identityStartTime' => 'setIdentityStartTime',
        ...
        'memo' => 'setMemo',
        'newBusinessTime' => 'setNewBusinessTime',
    ...
    protected static $getters = [
        ...
        'certNo' => 'getCertNo',
        'certStartExpireTime' => 'getCertStartExpireTime',
        ...
        'fundProofs' => 'getFundProofs',
        'fundType' => 'getFundType',
        'identityBackUrl' => 'getIdentityBackUrl',
        'identityEndTime' => 'getIdentityEndTime',
        'identityFrontUrl' => 'getIdentityFrontUrl',
        'identityStartTime' => 'getIdentityStartTime',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['certStartExpireTime'] = $data['certStartExpireTime'] ?? null;
        ...
        $this->container['fundProofs'] = $data['fundProofs'] ?? null;
        $this->container['fundType'] = $data['fundType'] ?? null;
        $this->container['identityBackUrl'] = $data['identityBackUrl'] ?? null;
        $this->container['identityEndTime'] = $data['identityEndTime'] ?? null;
        $this->container['identityFrontUrl'] = $data['identityFrontUrl'] ?? null;
        $this->container['identityStartTime'] = $data['identityStartTime'] ?? null;
        ...
        $this->container['newBusinessTime'] = $data['newBusinessTime'] ?? null;
        ...
        $this->container['shopMainType'] = $data['shopMainType'] ?? null;
     ...
     * Sets businessTime
     *
     * @param \Alipay\OpenAPISDK\Model\ShopBusinessTime[]|null $businessTime 门店经营时间。
     *
     * @return self
     */
     ...
     * Sets certNo
     *
     * @param string|null $certNo 证件号码，请填写门店营业执照号。
     *
     * @return self
     */
    ...
    /**
     * Gets certStartExpireTime
     *
     * @return string|null
     */
    public function getCertStartExpireTime()
    {
        return $this->container['certStartExpireTime'];
    }

    /**
     * Sets certStartExpireTime
     *
     * @param string|null $certStartExpireTime 营业执照的开始时间
     *
     * @return self
     */
    public function setCertStartExpireTime($certStartExpireTime)
    {
        $this->container['certStartExpireTime'] = $certStartExpireTime;
     ...
     * Sets contactMobile
     *
     * @param string|null $contactMobile 门店联系手机号
     *
     * @return self
     */
     ...
     * Sets contactPhone
     *
     * @param string|null $contactPhone 门店的联系固定电话
     *
     * @return self
     */
     ...
     * Sets expireTime
     *
     * @param string|null $expireTime 营业执照过期时间
     *
     * @return self
     */
     ...
     * Sets extInfos
     *
     * @param \Alipay\OpenAPISDK\Model\ShopExtInfo[]|null $extInfos 扩展信息列表。key值需要向对应行业的bd进行申请。 如果是针对神券团购门店的操作，该值必传，且无需向bd申请。
     *
     * @return self
     */
     ...
     * @return string[]|null
     */
    public function getFundProofs()
    {
        return $this->container['fundProofs'];
    }

    /**
     * Sets fundProofs
     *
     * @param string[]|null $fundProofs 需传入<a href=\"https://opendocs.alipay.com/apis/api_1*ant.merchant.expand.indirect.image.upload\">ant.merchant.expand.indirect.image.upload</a> 接口上传图片后得到的 image_id。
     *
     * @return self
     */
    public function setFundProofs($fundProofs)
    {
        $this->container['fundProofs'] = $fundProofs;
     ...
     * Sets fundType
     *
     * @param string|null $fundType 资金关系说明
     *
     * @return self
     */
    ...
    /**
     * Gets identityBackUrl
     *
     * @return string|null
     */
    public function getIdentityBackUrl()
    {
        return $this->container['identityBackUrl'];
    }

    /**
     * Sets identityBackUrl
     *
     * @param string|null $identityBackUrl 需传入<a href=\"https://opendocs.alipay.com/apis/api_1*ant.merchant.expand.indirect.image.upload\">ant.merchant.expand.indirect.image.upload</a> 接口上传图片后得到的 image_id。
     *
     * @return self
     */
    public function setIdentityBackUrl($identityBackUrl)
    {
        $this->container['identityBackUrl'] = $identityBackUrl;

        return $this;
    }

    /**
     * Gets identityEndTime
     *
     * @return string|null
     */
    public function getIdentityEndTime()
    {
        return $this->container['identityEndTime'];
    }

    /**
     * Sets identityEndTime
     *
     * @param string|null $identityEndTime 身份证有效结束时间,国徽面信息
     *
     * @return self
     */
    public function setIdentityEndTime($identityEndTime)
    {
        $this->container['identityEndTime'] = $identityEndTime;

        return $this;
    }

    /**
     * Gets identityFrontUrl
     *
     * @return string|null
     */
    public function getIdentityFrontUrl()
    {
        return $this->container['identityFrontUrl'];
    }

    /**
     * Sets identityFrontUrl
     *
     * @param string|null $identityFrontUrl 需传入<a href=\"https://opendocs.alipay.com/apis/api_1*ant.merchant.expand.indirect.image.upload\">ant.merchant.expand.indirect.image.upload</a> 接口上传图片后得到的 image_id。
     *
     * @return self
     */
    public function setIdentityFrontUrl($identityFrontUrl)
    {
        $this->container['identityFrontUrl'] = $identityFrontUrl;

        return $this;
    }

    /**
     * Gets identityStartTime
     *
     * @return string|null
     */
    public function getIdentityStartTime()
    {
        return $this->container['identityStartTime'];
    }

    /**
     * Sets identityStartTime
     *
     * @param string|null $identityStartTime 身份证的有效开始时间，国徽面信息
     *
     * @return self
     */
    public function setIdentityStartTime($identityStartTime)
    {
        $this->container['identityStartTime'] = $identityStartTime;
     ...
     * Sets ipRoleId
     *
     * @param string|null $ipRoleId 当前门店归属的商户角色 ID，表示当前进件的门店的归属商户。对于直连开店场景，填写商户 PID。对于间连开店场景（线上、线下、直付通），商户SMID
     *
     * @return self
     */
    ...
    /**
     * Gets newBusinessTime
     *
     * @return \Alipay\OpenAPISDK\Model\ComplexBusinessTime[]|null
     */
    public function getNewBusinessTime()
    {
        return $this->container['newBusinessTime'];
    }

    /**
     * Sets newBusinessTime
     *
     * @param \Alipay\OpenAPISDK\Model\ComplexBusinessTime[]|null $newBusinessTime 门店营业时间，支持一周7天，支持1天内多时间段
     *
     * @return self
     */
    public function setNewBusinessTime($newBusinessTime)
    {
        $this->container['newBusinessTime'] = $newBusinessTime;
     ...
     * @return string|null
     */
    public function getShopMainType()
    {
        return $this->container['shopMainType'];
    }

    /**
     * Sets shopMainType
     *
     * @param string|null $shopMainType 主要针对医疗行业门店主体类型进件使用，不同门店认证主体需要相应的主体资质证书。  企业营业执照：ENTERPRISE;  事业单位法人证书：INST_RGST_CTF;  民办非企业单位登记证书：PRIVATE_NON_ENTERPRISE; 企业（澳门）：AOMEN_ENTERPRISE
     *
     * @return self
     */
    public function setShopMainType($shopMainType)
    {
        $this->container['shopMainType'] = $shopMainType;
     ...
     * Sets shopName
     *
     * @param string|null $shopName 门店名称, 由商户定义在支付宝内的门店名称
     *
     * @return self
     */
     ...
     * Sets shopType
     *
     * @param string|null $shopType 门店经营类型，01表示直营，02表示加盟
     *
     * @return self
     */
