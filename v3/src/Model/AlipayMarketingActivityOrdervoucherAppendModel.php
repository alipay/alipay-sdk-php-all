...
class AlipayMarketingActivityOrdervoucherAppendModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int|null $voucherQuantity 券总预算值。  限制： 券总预算<= 999999  特别说明： 该字段的含义是追加到的数量。 不可减少，只能增加。  code_mode= MERCHANT_UPLOAD 的情况下，voucher_quantity 需要与导入码的总数量保持一致（即历史导入数量 + 追加导入数量）。
     *
     * @return self
     */
