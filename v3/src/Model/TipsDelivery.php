...
class TipsDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $deliveryContent 收藏引导文案内容
     *
     * @return self
     */
     ...
     * Sets deliveryName
     *
     * @param string|null $deliveryName 收藏引导投放活动的名称
     *
     * @return self
     */
     ...
     * Sets matchType
     *
     * @param string|null $matchType 匹配类型：GLOBAL为全局生效，TARGETURL为目标页面生效，需配置相应页面地址match_url。
     *
     * @return self
     */
     ...
     * Sets matchUrl
     *
     * @param string|null $matchUrl 目标页面地址
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status 活动状态。 枚举值： INIT: 初始化；AUDITING: 审核中；AUDIT_REJECTED:审核驳回；WORKING: 生效中；PUASE: 暂停；FINISHED 已结束；
     *
     * @return self
     */
