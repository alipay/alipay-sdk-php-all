...
class IssueRuleInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $effectivePeriod 生效周期，不限：\"{\\\"all\\\":true}\"，默认为不限
     *
     * @return self
     */
     ...
     * Sets invalidMode
     *
     * @param int|null $invalidMode 是否可累计，枚举：0（不可累计）、1（可累计），默认为0
     *
     * @return self
     */
     ...
     *
     * @param string|null $invalidModeValue 失效模式值
     *
     * @return self
     */
     ...
     *
     * @param string|null $issueAmountValue 发放金额，按城市不同发放标准示例值：\"[{/\"cities/\":[/\"321000/\",/\"321100/\"],amount:/\"50/\"}, {/\"cities/\":[/\"321200/\",/\"321300/\"],amount:/\"150/\"}]\" 统一标准发放示例值：200
     *
     * @return self
     */
     ...
     * Sets issueEndDate
     *
     * @param string|null $issueEndDate 如果target_type指定INSTITUTION，则使用制度有效期结束时间，无需填写
     *
     * @return self
     */
     ...
     * Sets issueRuleId
     *
     * @param string|null $issueRuleId 发放规则id，创建时无需填写
     *
     * @return self
     */
     ...
     * Sets issueStartDate
     *
     * @param string|null $issueStartDate 如果target_type指定INSTITUTION，则使用制度有效期起始时间，无需填写
     *
     * @return self
     */
     ...
     * Sets issueType
     *
     * @param string|null $issueType 发放类型，枚举：ISSUE_MONTH（按月发放）、ISSUE_DAY（按日发放）
     *
     * @return self
     */
     ...
     * Sets outerSourceId
     *
     * @param string|null $outerSourceId 外部发放规则id，制度内发放规则该字段不允许重复
     *
     * @return self
     */
     ...
     * Sets shareMode
     *
     * @param int|null $shareMode 是否可转赠，枚举：0（不可转赠）、1（可转赠），默认为0
     *
     * @return self
     */
