...
class InvoicePDFSynModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets applyId
     *
     * @param string|null $applyId 支付宝开票申请id。 当userId为空时，必填； 如果在开票过程中，是通过支付宝提交的申请到开票服务方，支付宝会带上开票申请在支付宝生成的申请id，开票服务方在回传发票的时候只需要回传这个申请id，不用获取用户的userId，支付宝可以根据申请id将发票归集到对应的用户名下
     *
     * @return self
     */
     ...
     * Sets fileBase
     *
     * @param string|null $fileBase base64化的字符串
     *
     * @return self
     */
     ...
     *
     * @param string|null $fileDownloadType PDF类型文件填写PDF， OFD类型文件填写ofd， JPG类型文件填写JPG(JPG文件请先询问对接人当前是否支持)
     *
     * @return self
     */
     ...
     *
     * @param string|null $fileDownloadUrl 发票文件下载地址。
     *
     * @return self
     */
     ...
     * Sets userId
     *
     * @param string|null $userId 支付宝用户userId； 当apply_id为空时，userId必填
     *
     * @return self
     */
