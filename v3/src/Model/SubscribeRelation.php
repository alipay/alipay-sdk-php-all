...
class SubscribeRelation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets keepState
     *
     * @param string|null $keepState 订阅保持状态，即用户勾选“总是保持以上选择，不再询问”选项时勾选的订阅状态。枚举值： 0：保持订阅。 1：保持拒绝订阅。 说明：若用户“总是保持以上选择，不再询问”选项，且选择订阅消息。下次触发消息订阅组件时，支付宝将自动发起一次静默订阅（不再拉起订阅组件，无需用户手动订阅）。
     *
     * @return self
     */
