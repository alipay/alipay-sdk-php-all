...
class AlipayEbppInvoiceExpensecontrolIssuebatchCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets accountId
     *
     * @param string|null $accountId 共同账户id - 通过企业码1.0接口签约的共同账户，和agreement_no搭配使用
     *
     * @return self
     */
     ...
     * Sets enterpriseId
     *
     * @param string|null $enterpriseId 企业ID - 通过企业码2.0签约接口签约的企业
     *
     * @return self
     */
     ...
     * Sets shareMode
     *
     * @param string|null $shareMode 是否可转赠，枚举：0（不可转赠）、1（可转赠）
     *
     * @return self
     */
