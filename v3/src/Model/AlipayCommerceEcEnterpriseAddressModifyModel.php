...
class AlipayCommerceEcEnterpriseAddressModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets accountId
     *
     * @param string|null $accountId 共同账户id和enterprise_id二选一
     *
     * @return self
     */
     ...
     * Sets agreementNo
     *
     * @param string|null $agreementNo 协议号，如果填共同账户id，则该字段必填
     *
     * @return self
     */
     ...
     * Sets enterpriseId
     *
     * @param string|null $enterpriseId 企业id和account_id二选一
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status 状态(生效/失效) NORMAL INVALID
     *
     * @return self
     */
