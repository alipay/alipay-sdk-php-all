...
class AlipayEbppInvoiceInstitutionScopepageinfoQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets adapterType
     *
     * @param string|null $adapterType 制度下人员生效范围，枚举值： EMPLOYEE_ALL(全体员工), EMPLOYEE_SELECT(自定义员工), EMPLOYEE_DEPARTMENT(部门)
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $onwerOpenIdList 切换 open_id 后请使用此字段： adapter_type为： EMPLOYEE_DEPARTMENT：返回部门ID EMPLOYEE_SELECT：当owner_type为PHONE时返回手机号，其他值则根据对接方式返回open_id，或企业码员工ID
     *
     * @return self
     */
     ...
     * Sets ownerIdList
     *
     * @param string[]|null $ownerIdList 未切换 open_id 时请使用此字段： adapter_type为： EMPLOYEE_DEPARTMENT：返回部门ID EMPLOYEE_SELECT：当owner_type为PHONE时返回手机号，其他值则根据对接方式返回支付宝用户ID，或企业码员工ID
     *
     * @return self
     */
     ...
     * Sets totalPageCount
     *
     * @param int|null $totalPageCount 总数
     *
     * @return self
     */
