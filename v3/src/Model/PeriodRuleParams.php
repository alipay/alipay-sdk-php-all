...
class PeriodRuleParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['isTrialMode'] = $data['isTrialMode'] ?? null;
    ...
    {
        return $this->container['isTrialMode'];
    }

    /**
     * Sets isTrialMode
     *
     * @param string|null $isTrialMode 若签约中传该参数，且值为 Y ，则表示本次签约有试用期。若传值为 N 或不传该参数，则表示本次签约无试用期。
     *
     * @return self
     */
    public function setIsTrialMode($isTrialMode)
    {
        $this->container['isTrialMode'] = $isTrialMode;
