...
class AlipayEbppInvoiceInstitutionScopeModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets adapterType
     *
     * @param string|null $adapterType 制度适配范围类型
     *
     * @return self
     */
     ...
     * Sets addOwnerIdList
     *
     * @param string[]|null $addOwnerIdList 未切换open_id时请使用：adapterType为EMPLOYEE_ALL时，无需填写；adapterType为EMPLOYEE_SELECT时，填写员工id（可通过设置owner_type来指定id类型，支持员工支付宝id，员工企业码id和员工手机号）; adapterType为EMPLOYEE_DEPARTMENT时，填写部门id
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $addOwnerOpenIdList 切换open_id后请使用：adapterType为EMPLOYEE_ALL时，无需填写；adapterType为EMPLOYEE_SELECT时，填写员工id（可通过设置owner_type来指定id类型，支持员工open_id，员工企业码id和员工手机号）; adapterType为EMPLOYEE_DEPARTMENT时，填写部门id
     *
     * @return self
     */
     ...
     * Sets ownerType
     *
     * @param string|null $ownerType 当adapterType为指定员工时，通过该字段指定操作的owner_id类型
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $removeOwnerIdList 未切换open_id时请使用：adapterType为EMPLOYEE_ALL时，无需填写；adapterType为EMPLOYEE_SELECT时，填写员工id（可通过设置owner_type来指定id类型，支持员工支付宝id，员工企业码id和员工手机号）; adapterType为EMPLOYEE_DEPARTMENT时，填写部门id
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $removeOwnerOpenIdList 切换open_id后请使用：adapterType为EMPLOYEE_ALL时，无需填写；adapterType为EMPLOYEE_SELECT时，填写员工id（可通过设置owner_type来指定id类型，支持员工open_id，员工企业码id和员工手机号）; adapterType为EMPLOYEE_DEPARTMENT时，填写部门id
     *
     * @return self
     */
