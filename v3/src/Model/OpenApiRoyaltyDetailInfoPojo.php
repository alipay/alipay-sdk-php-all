...
class OpenApiRoyaltyDetailInfoPojo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets royaltyType
     *
     * @param string|null $royaltyType 分账类型.  普通分账为：transfer;  补差为：replenish;  为空默认为分账transfer;
     *
     * @return self
     */
     ...
     * Sets transInType
     *
     * @param string|null $transInType 收入方账户类型。userId表示是支付宝账号对应的支付宝唯一用户号;cardAliasNo表示是卡编号;loginName表示是支付宝登录号；
     *
     * @return self
     */
     ...
     * Sets transOutType
     *
     * @param string|null $transOutType 支出方账户类型。userId表示是支付宝账号对应的支付宝唯一用户号;loginName表示是支付宝登录号； 泛金融类商户分账时，该字段不要上送。
     *
     * @return self
     */
