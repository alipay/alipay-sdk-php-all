...
class OpenApiRoyaltyDetailInfoPojo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['transInId'] = $data['transInId'] ?? null;
     ...
     * Sets transIn
     *
     * @param string|null $transIn 收入方账户。如果收入方账户类型为userId，本参数为收入方的支付宝账号对应的支付宝唯一用户号，以2088开头的纯16位数字；如果收入方类型为cardAliasNo，本参数为收入方在支付宝绑定的卡编号；如果收入方类型为loginName，本参数为收入方的支付宝登录号；如果收入方类型为loginName，本参数为收入方的支付宝登录号；如果收入方类型为openId，本参数为收入方的支付宝openId信息；如果收入方类型为alipayWallet，本参数为收入方在支付宝绑定的场景钱包id
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getTransInId()
    {
        return $this->container['transInId'];
    }

    /**
     * Sets transInId
     *
     * @param string|null $transInId 分账转入方的支付宝userId
     *
     * @return self
     */
    public function setTransInId($transInId)
    {
        $this->container['transInId'] = $transInId;
