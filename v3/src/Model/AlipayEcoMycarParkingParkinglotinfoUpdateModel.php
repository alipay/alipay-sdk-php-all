...
class AlipayEcoMycarParkingParkinglotinfoUpdateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['remainSpace'] = $data['remainSpace'] ?? null;
     ...
     * @return string|null
     */
    public function getRemainSpace()
    {
        return $this->container['remainSpace'];
    }

    /**
     * Sets remainSpace
     *
     * @param string|null $remainSpace 剩余车位数 单位：个
     *
     * @return self
     */
    public function setRemainSpace($remainSpace)
    {
        $this->container['remainSpace'] = $remainSpace;
