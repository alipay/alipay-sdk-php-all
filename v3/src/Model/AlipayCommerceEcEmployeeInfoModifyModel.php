...
class AlipayCommerceEcEmployeeInfoModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string[]|null $accountingEntityIds 员工所属核算主体，核算主体可用于管控不同员工的出资方式，建议和不同出资账户关联，一个员工只能有一个核算主体。
     *
     * @return self
     */
     ...
     * Sets labelNames
     *
     * @param string[]|null $labelNames 员工标签，用于员工的打标分类，后续费控管理可使用标签进行控制，支持输入多个标签，如“差旅员工，用餐员工”等；<br/><br/> 使用场景：1. 请严格对标签分类，不要滥用员工标签，否则影响员工和费控管理； 2. 一个员工最多10个标签，如无必要请勿使用；3. 标签名只能包含字母（大小写）、数字或中文字符
     *
     * @return self
     */
