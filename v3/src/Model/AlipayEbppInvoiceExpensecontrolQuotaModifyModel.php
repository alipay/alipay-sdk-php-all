...
class AlipayEbppInvoiceExpensecontrolQuotaModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets action
     *
     * @param string|null $action 变更模式 ADD - 给余额/点券增加amount DEDUCT - 给余额/点券扣减amount UPDATE_BALANCE-更新余额/点券可用额度为amount FREEZE-余额/点券冻结（若冻结，则员工因公支付不可用） UNFREEZE-余额/点券解冻 DELETE-余额/点券删除（使用过的点券不支持删除）
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string|null $amount 变更的金额/余额，以（分）为单位
     *
     * @return self
     */
