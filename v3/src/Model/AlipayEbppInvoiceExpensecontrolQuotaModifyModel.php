...
class AlipayEbppInvoiceExpensecontrolQuotaModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $getters = [
        ...
        'allowNegative' => 'getAllowNegative',
        'amount' => 'getAmount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['allowNegative'] = $data['allowNegative'] ?? null;
    ...
    {
        return $this->container['allowNegative'];
    }

    /**
     * Sets allowNegative
     *
     * @param bool|null $allowNegative 修改余额对应的额度时是否允许修改为负数，true表示允许，false表示不允许。默认允许
     *
     * @return self
     */
    public function setAllowNegative($allowNegative)
    {
        $this->container['allowNegative'] = $allowNegative;
