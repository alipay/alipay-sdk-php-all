...
class AlipayEbppInvoiceExpensecontrolQuotaModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets action
     *
     * @param string|null $action 变更模式 ADD - 给余额增加amount DEDUCT - 给余额扣减amount UPDATE_BALANCE-更新可用余额为amount FREEZE-余额冻结（若冻结，则员工因公支付不可用） UNFREEZE-余额解冻 DELETE-余额删除/点券删除
     *
     * @return self
     */
