...
class AlipayFundTransCommonQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'errorCode' => 'string',
        'failInstErrorCode' => 'string',
        'failInstName' => 'string',
        'failInstReason' => 'string',
        'failReason' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'failInstErrorCode' => 'fail_inst_error_code',
        'failInstName' => 'fail_inst_name',
        'failInstReason' => 'fail_inst_reason',
        ...
        'subPayFundOrderId' => 'sub_pay_fund_order_id',
    ...
    protected static $setters = [
        ...
        'failInstErrorCode' => 'setFailInstErrorCode',
        'failInstName' => 'setFailInstName',
        'failInstReason' => 'setFailInstReason',
        ...
        'subPayFundOrderId' => 'setSubPayFundOrderId',
    ...
    protected static $getters = [
        ...
        'failInstErrorCode' => 'getFailInstErrorCode',
        'failInstName' => 'getFailInstName',
        'failInstReason' => 'getFailInstReason',
        ...
        'subPayFundOrderId' => 'getSubPayFundOrderId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['failInstErrorCode'] = $data['failInstErrorCode'] ?? null;
        $this->container['failInstName'] = $data['failInstName'] ?? null;
        $this->container['failInstReason'] = $data['failInstReason'] ?? null;
        ...
        $this->container['subPayFundOrderId'] = $data['subPayFundOrderId'] ?? null;
    ...
    /**
     * Gets failInstErrorCode
     *
     * @return string|null
     */
    public function getFailInstErrorCode()
    {
        return $this->container['failInstErrorCode'];
    }

    /**
     * Sets failInstErrorCode
     *
     * @param string|null $failInstErrorCode 查询到的订单状态为FAIL失败时，返回具体报错银行的错误码。
     *
     * @return self
     */
    public function setFailInstErrorCode($failInstErrorCode)
    {
        $this->container['failInstErrorCode'] = $failInstErrorCode;
     ...
     * @return string|null
     */
    public function getFailInstName()
    {
        return $this->container['failInstName'];
    }

    /**
     * Sets failInstName
     *
     * @param string|null $failInstName 查询到的订单状态为FAIL失败时，返回具体的报错银行名称
     *
     * @return self
     */
    public function setFailInstName($failInstName)
    {
        $this->container['failInstName'] = $failInstName;
     ...
     * @return string|null
     */
    public function getFailInstReason()
    {
        return $this->container['failInstReason'];
    }

    /**
     * Sets failInstReason
     *
     * @param string|null $failInstReason 查询到的订单状态为FAIL失败时，返回具体的原因。
     *
     * @return self
     */
    public function setFailInstReason($failInstReason)
    {
        $this->container['failInstReason'] = $failInstReason;
    ...
    /**
     * Gets subPayFundOrderId
     *
     * @return string|null
     */
    public function getSubPayFundOrderId()
    {
        return $this->container['subPayFundOrderId'];
    }

    /**
     * Sets subPayFundOrderId
     *
     * @param string|null $subPayFundOrderId 支付宝支付子单资金流水号，当二阶段主子单场景时需要使用该单号去下载电子回单
     *
     * @return self
     */
    public function setSubPayFundOrderId($subPayFundOrderId)
    {
        $this->container['subPayFundOrderId'] = $subPayFundOrderId;
