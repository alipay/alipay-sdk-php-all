...
class PaymentVoucherSendRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $voucherQuantityLimitPerUserPeriodType 周期限领配置,限制每人在固定周期内领取张数(voucher_quantity_limit_per_user),默认LIFE_CYCLE  枚举值为  DAY:每天 WEEK:每周 MONTH:每月 LIFE_CYCLE:整个活动周期
     *
     * @return self
     */
