...
class AlipayTradeFastpayRefundQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $presentRefundBuyerAmount 本次退款金额中买家退款金额。 该字段默认不返回；
     *
     * @return self
     */
     ...
     *
     * @param string|null $presentRefundDiscountAmount 本次退款金额中平台优惠退款金额。 该字段默认不返回；
     *
     * @return self
     */
     ...
     *
     * @param string|null $presentRefundMdiscountAmount 本次退款金额中商家优惠退款金额。 该字段默认不返回；
     *
     * @return self
     */
     ...
     *
     * @param string|null $refundChargeAmount 本次退款针对收款方的退收费金额； 只在机构间联模式下返回，其它场景下不返回该字段；
     *
     * @return self
     */
     ...
     *
     * @param string|null $refundHybAmount 本次退款金额中退惠营宝的金额
     *
     * @return self
     */
     ...
     * Sets refundRoyaltys
     *
     * @param \Alipay\OpenAPISDK\Model\RefundRoyaltyResult[]|null $refundRoyaltys 退分账明细信息
     *
     * @return self
     */
     ...
     * Sets sendBackFee
     *
     * @param string|null $sendBackFee 本次商户实际退回金额； 默认不返回该信息，需要在入参的query_options中指定\"refund_detail_item_list\"值时才返回该字段信息。
     *
     * @return self
     */
     ...
     * Sets totalAmount
     *
     * @param string|null $totalAmount 该笔退款所对应的交易的订单金额
     *
     * @return self
     */
