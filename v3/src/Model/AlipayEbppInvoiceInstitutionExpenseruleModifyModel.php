...
class AlipayEbppInvoiceInstitutionExpenseruleModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets action
     *
     * @param string|null $action 修改使用规则，操作枚举： ADD_RULE（新增使用条件）， DELETE_RULE（删除使用条件）， MODIFY_RULE（修改使用条件），MODIFY_BASIC_INFO（修改规则基本信息）
     *
     * @return self
     */
     ...
     * Sets consumeMode
     *
     * @param string|null $consumeMode 该使用规则支持的资产消费模式，不填写则为默认模式，默认模式下有余额时使用余额，没有余额则使用规则中的限额
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\ExpenseCtrRuleInfo[]|null $expenseCtrlRuleInfoList 使用规则条件列表
     *
     * @return self
     */
     ...
     * Sets openRuleId
     *
     * @param string|null $openRuleId 开票规则id，如果之前已关联开票规则，则更换开票规则id不生效
     *
     * @return self
     */
     ...
     * Sets paymentPolicy
     *
     * @param string|null $paymentPolicy 当笔消费金额大于规则可用余额时，用于控制支付策略，该字段缺省时采取因公账户和个人账户组合支付策略COMBINATION
     *
     * @return self
     */
     ...
     * Sets standardDesc
     *
     * @param string|null $standardDesc 规则描述（敏感词校验）
     *
     * @return self
     */
     ...
     * Sets standardName
     *
     * @param string|null $standardName 规则名称（敏感词校验）
     *
     * @return self
     */
