...
class AlipayMerchantOrderSyncDefaultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CODE_SETTLEQUERY_INVOKE_ERROR = 'SETTLEQUERY_INVOKE_ERROR';
    public const CODE_TRADEQUERY_INVOKE_ERROR = 'TRADEQUERY_INVOKE_ERROR';
    ...
    public function getCodeAllowableValues()
    {
        return [
            ...
            self::CODE_SETTLEQUERY_INVOKE_ERROR,
            self::CODE_TRADEQUERY_INVOKE_ERROR,
