...
class AlipayCommerceEcEnterpriseCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets identity
     *
     * @param string|null $identity 身份，对应身份类型进行传参，例如： 企业支付宝登录账号(支持手机号或者邮箱)或企业支付宝会员id(对应2088开头的支付宝会员id)
     *
     * @return self
     */
     ...
     * Sets identityType
     *
     * @param string|null $identityType 身份类型,目前支持传参如下： ALIPAY_LOGON_ID(企业支付宝登录账号) ALIPAY_USER_ID(企业支付宝会员id)
     *
     * @return self
     */
