...
class EmployeeInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets activate
     *
     * @param string|null $activate 是否激活，可选值：ACTIVATED-已激活；UNACTIVATED-未激活；ACTIVATING-激活中
     *
     * @return self
     */
     ...
     * Sets roleList
     *
     * @param string[]|null $roleList 角色列表，可选值：USER-用户；ADMIM-管理员 SUPER_ADMIN-超级管理员
     *
     * @return self
     */
