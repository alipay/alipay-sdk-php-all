...
class AlipayMarketingActivityDeliveryStopResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\ErrorDeliveryConfig[]|null $errorDeliveryConfigList [已废弃] 停止失败的投放配置列表
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\SuccessDeliveryConfig[]|null $successDeliveryConfigList [已废弃] 停止成功的投放配置列表
     *
     * @return self
     */
