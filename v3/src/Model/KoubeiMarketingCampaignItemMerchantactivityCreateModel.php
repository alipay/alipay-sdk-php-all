...
/**
 * KoubeiMarketingCampaignItemMerchantactivityCreateModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class KoubeiMarketingCampaignItemMerchantactivityCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KoubeiMarketingCampaignItemMerchantactivityCreateModel';
    ...
    protected static $attributeMap = [
        ...
        'externalCallbackUrl' => 'external_callback_url',
    ...
    protected static $setters = [
        ...
        'externalCallbackUrl' => 'setExternalCallbackUrl',
    ...
    protected static $getters = [
        ...
        'externalCallbackUrl' => 'getExternalCallbackUrl',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['externalCallbackUrl'] = $data['externalCallbackUrl'] ?? null;
     ...
     * Sets countLimit
     *
     * @param int|null $countLimit 活动优惠次数限制，必须设置。 说明：活动优惠总次数限制不能小于1，且不能大于99999999。
     *
     * @return self
     */
     ...
     *
     * @param int|null $countLimitPerDay 活动优惠单日次数限制。 说明：活动优惠单日次数限制不能为负数，不能大于99999999；0表示不限制。
     *
     * @return self
     */
     ...
     *
     * @param int|null $countLimitPerUser 活动单用户限次。 说明：活动单用户总限次不能为负数，不能大于999。0表示不限制。
     *
     * @return self
     */
     ...
     *
     * @param int|null $countLimitPerUserPerDay 活动单用户单日限次。 说明：活动单用户单日限次不能为负数，不能大于999。0表示不限制。
     *
     * @return self
     */
     ...
     * Sets crowd
     *
     * @param string|null $crowd 群规则，枚举支持： * DEFAULT： 全部用户； * ONLINE_NEWCOMER：在线购买新人； * MEMBER：会员。
     *
     * @return self
     */
     ...
     * Sets deductAmount
     *
     * @param string|null $deductAmount 代金券面额，单位为元。 说明：代金券面额格式必须为#.##，代金券面额需小于49999。
     *
     * @return self
     */
    ...
    /**
     * Gets externalCallbackUrl
     *
     * @return string|null
     */
    public function getExternalCallbackUrl()
    {
        return $this->container['externalCallbackUrl'];
    }

    /**
     * Sets externalCallbackUrl
     *
     * @param string|null $externalCallbackUrl 外部回调地址，最大字符数不能超过500。
     *
     * @return self
     */
    public function setExternalCallbackUrl($externalCallbackUrl)
    {
        $this->container['externalCallbackUrl'] = $externalCallbackUrl;
     ...
     *
     * @param string|null $externalUniqueId 外部id，需保证同一账户下唯一。 说明：最小长度不能低于13，最大长度不能超过64。
     *
     * @return self
     */
     ...
     * Sets gmtEnd
     *
     * @param string|null $gmtEnd 活动结束时间。活动结束时间需大于活动开始时间。格式为\"yyyy-MM-dd HH:mm:ss\"。
     *
     * @return self
     */
     ...
     * Sets itemIds
     *
     * @param string[]|null $itemIds 商品列表。 说明：参加活动的商品列表不能为空，最大个数不能超过100。
     *
     * @return self
     */
     ...
     * Sets memo
     *
     * @param string|null $memo 备注。 说明：备注最大字符数不能超过500。
     *
     * @return self
     */
     ...
     * Sets minCost
     *
     * @param string|null $minCost 使用门槛，即满 min_cost 元可用，使用门槛必须大于券面额，单位为元。 说明：使用门槛格式必须为#.##。
     *
     * @return self
     */
