...
class AntMerchantExpandShopModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets businessTime
     *
     * @param \Alipay\OpenAPISDK\Model\ShopBusinessTime[]|null $businessTime 门店经营时间。若无需更新本信息项，可以不填写
     *
     * @return self
     */
     ...
     * Sets expireTime
     *
     * @param string|null $expireTime 证件过期时间,当是神券团购门店（ext_infos传了biz_source=APLUS_SHOP）并且license_type=3118或者A521时，必填
     *
     * @return self
     */
     ...
     * Sets extInfos
     *
     * @param \Alipay\OpenAPISDK\Model\ShopExtInfo[]|null $extInfos 扩展信息列表。key值需要向对应行业的bd进行申请。传入本项时，按key进行更新或补充。 如果是针对神券团购门店的操作，该值必传，且无需向bd申请。
     *
     * @return self
     */
     ...
     * Sets ipRoleId
     *
     * @param string|null $ipRoleId 商户角色id，表示将要修改的门店属于哪个商户角色，和store_id一起定位待修改的门店。对于直连场景，填写商户pid；对于间连场景（线上、线下、直付通），填写商户smid。本信息项不可修改
     *
     * @return self
     */
     ...
     * Sets shopId
     *
     * @param string|null $shopId 蚂蚁门店id，用于查出待修改的门店。填写本参数的话，store_id和ip_role_id可以不填。本信息项不可修改
     *
     * @return self
     */
     ...
     * Sets shopName
     *
     * @param string|null $shopName 门店名称。直连开店要保证全局门店名称+地址唯一，间连开店要保证服务商pid下门店名称+地址唯一。若无需更新本信息项，可以不填写
     *
     * @return self
     */
