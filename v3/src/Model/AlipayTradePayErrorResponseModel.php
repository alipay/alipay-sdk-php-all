...
class AlipayTradePayErrorResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CODE_BUYER_BANKCARD_INVALID = 'ACQ.BUYER_BANKCARD_INVALID';
    public const CODE_BUYER_BANKCARD_DECLINED = 'ACQ.BUYER_BANKCARD_DECLINED';
    ...
    public const CODE_BUYER_LIMIT_EXCEEDED = 'ACQ.BUYER_LIMIT_EXCEEDED';
    ...
    {
        return [
            self::CODE_BUYER_BANKCARD_INVALID,
            self::CODE_BUYER_BANKCARD_DECLINED,
            ...
            self::CODE_BUYER_LIMIT_EXCEEDED,
        ];
    }
