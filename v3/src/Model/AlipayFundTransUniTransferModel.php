...
class AlipayFundTransUniTransferModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'transferSceneReportInfos' => '\Alipay\OpenAPISDK\Model\TransferSceneReportInfo[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'signData' => null,
        'transAmount' => null,
        'transferSceneName' => null,
        'transferSceneReportInfos' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'transferSceneName' => 'transfer_scene_name',
    ...
    protected static $setters = [
        ...
        'transferSceneName' => 'setTransferSceneName',
        'transferSceneReportInfos' => 'setTransferSceneReportInfos'
    ];
    ...
    protected static $getters = [
        ...
        'transferSceneName' => 'getTransferSceneName',
        'transferSceneReportInfos' => 'getTransferSceneReportInfos'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['transferSceneName'] = $data['transferSceneName'] ?? null;
        $this->container['transferSceneReportInfos'] = $data['transferSceneReportInfos'] ?? null;
    }
    ...
    /**
     * Gets transferSceneName
     *
     * @return string|null
     */
    public function getTransferSceneName()
    {
        return $this->container['transferSceneName'];
    }

    /**
     * Sets transferSceneName
     *
     * @param string|null $transferSceneName 该笔转账使用的转账场景，商户可前往【<a href=\"https://b.alipay.com/page/bizfund/transferScene/list\">支付宝商家平台-资金管理-转账场景</a>】中查看/申明转账场景。<br> 目前支持以下枚举值：现金营销、企业退款、佣金报酬、业务结算、二手回收、公益补助、行政补贴和退款、保险理赔<br> <b>注意：</b>26年及以后新接入商户<b>必须</b>传入该字段。
     *
     * @return self
     */
    public function setTransferSceneName($transferSceneName)
    {
        $this->container['transferSceneName'] = $transferSceneName;

        return $this;
    }

    /**
     * Gets transferSceneReportInfos
     *
     * @return \Alipay\OpenAPISDK\Model\TransferSceneReportInfo[]|null
     */
    public function getTransferSceneReportInfos()
    {
        return $this->container['transferSceneReportInfos'];
    }

    /**
     * Sets transferSceneReportInfos
     *
     * @param \Alipay\OpenAPISDK\Model\TransferSceneReportInfo[]|null $transferSceneReportInfos 转账场景信息，包含转账场景信息类型和转账场景信息描述。需按该笔转账使用的转账场景准确填写<br> <b>注意：</b>26年及以后新接入商户<b>必须</b>传入该字段。
     *
     * @return self
     */
    public function setTransferSceneReportInfos($transferSceneReportInfos)
    {
        $this->container['transferSceneReportInfos'] = $transferSceneReportInfos;
