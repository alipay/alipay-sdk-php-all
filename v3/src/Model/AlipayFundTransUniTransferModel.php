...
class AlipayFundTransUniTransferModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $transferSceneName 该笔转账使用的转账场景，商户可前往【<a href=\"https://b.alipay.com/page/bizfund/transferScene/list\">支付宝商家平台-资金管理-转账场景</a>】中查看/申明转账场景。<br> 目前支持以下枚举值：现金营销、企业退款、佣金报酬、业务结算、二手回收、公益补助、行政补贴和退款、保险理赔
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\TransferSceneReportInfo[]|null $transferSceneReportInfos 转账场景信息，包含转账场景信息类型和转账场景信息描述。需按该笔转账使用的转账场景准确填写
     *
     * @return self
     */
