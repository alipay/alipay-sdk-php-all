...
class AlipayCommerceTransportParkingPaymentinfoSyncModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets nodeType
     *
     * @param string|null $nodeType 表示当前请求类型：用户缴费或用户在岗亭前缴费准备离场状态
     *
     * @return self
     */
     ...
     *
     * @param string|null $orderCreateTime 停车岗亭前订单创建时间，格式\"YYYY-MM-DD HH:mm:ss\"，24小时制，请保证服务器时间准确，创建时不应晚于当前网络时间
     *
     * @return self
     */
