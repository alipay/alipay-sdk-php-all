...
class AlipayTradeCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets passbackParams
     *
     * @param string|null $passbackParams 公用回传参数。如果请求时传递了该参数，则会在支付结果异步通知中将该参数原样返回。本参数必须进行UrlEncode之后才可以发送给支付宝。
     *
     * @return self
     */
     ...
     * Sets subject
     *
     * @param string|null $subject 订单标题。 注意：256个字符以内，不可使用特殊字符，如 /，=，& 等。
     *
     * @return self
     */
