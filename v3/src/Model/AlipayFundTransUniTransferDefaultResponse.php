...
class AlipayFundTransUniTransferDefaultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CODE_ENTERPRISE_IDENTITY_INFO_NEED_UPDATE = 'ENTERPRISE_IDENTITY_INFO_NEED_UPDATE';
    public const CODE_CHECK_RECEIVER_CERT_NOT_ALLOW = 'CHECK_RECEIVER_CERT_NOT_ALLOW';
    public const CODE_EXPAND_INDIRECT_VERIFY_FAIL = 'EXPAND_INDIRECT_VERIFY_FAIL';
    ...
    public const CODE_PAYER_ACCOUNT_LIMIT = 'PAYER_ACCOUNT_LIMIT';
    public const CODE_PAYER_AND_PAYEE_BOTH_PERSONAL_ACCOUNT_BOOK = 'PAYER_AND_PAYEE_BOTH_PERSONAL_ACCOUNT_BOOK';
    public const CODE_TRANSFER_SCENE_NAME_ILLEGAL = 'TRANSFER_SCENE_NAME_ILLEGAL';
    public const CODE_TRANSFER_SCENE_REPORT_INFO_ILLEGAL = 'TRANSFER_SCENE_REPORT_INFO_ILLEGAL';
    public const CODE_TRANSFER_SCENE_NAME_BLANK = 'TRANSFER_SCENE_NAME_BLANK';
    public const CODE_TRANSFER_SCENE_INFO_ADMIT_FAIL = 'TRANSFER_SCENE_INFO_ADMIT_FAIL';
    public const CODE_ENTRUST_TRANSFER_NO_ACCOUNT_PAYMENT_PERMISSION = 'ENTRUST_TRANSFER_NO_ACCOUNT_PAYMENT_PERMISSION';
    public const CODE_IDENTITY_CARD_INFO_INVALID = 'IDENTITY_CARD_INFO_INVALID';
    public const CODE_AUTH_LOGONID_CHANGED = 'AUTH_LOGONID_CHANGED';
    ...
    public function getCodeAllowableValues()
    {
        return [
            ...
            self::CODE_ENTERPRISE_IDENTITY_INFO_NEED_UPDATE,
            self::CODE_CHECK_RECEIVER_CERT_NOT_ALLOW,
            self::CODE_EXPAND_INDIRECT_VERIFY_FAIL,
            ...
            self::CODE_PAYER_ACCOUNT_LIMIT,
            self::CODE_PAYER_AND_PAYEE_BOTH_PERSONAL_ACCOUNT_BOOK,
            self::CODE_TRANSFER_SCENE_NAME_ILLEGAL,
            self::CODE_TRANSFER_SCENE_REPORT_INFO_ILLEGAL,
            self::CODE_TRANSFER_SCENE_NAME_BLANK,
            self::CODE_TRANSFER_SCENE_INFO_ADMIT_FAIL,
            self::CODE_ENTRUST_TRANSFER_NO_ACCOUNT_PAYMENT_PERMISSION,
            self::CODE_IDENTITY_CARD_INFO_INVALID,
            self::CODE_AUTH_LOGONID_CHANGED,
        ];
    }
