...
class AlipayTradeRefundResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets refundFee
     *
     * @param string|null $refundFee 退款总金额。 指该笔交易累计已经退款成功的金额。
     *
     * @return self
     */
     ...
     *
     * @param string|null $refundHybAmount 本次请求退惠营宝金额
     *
     * @return self
     */
     ...
     * Sets sendBackFee
     *
     * @param string|null $sendBackFee 本次商户实际退回金额。 说明：如需获取该值，需在入参query_options中传入 refund_detail_item_list。
     *
     * @return self
     */
     ...
     * Sets tradeNo
     *
     * @param string|null $tradeNo 2013112011001004330000121536
     *
     * @return self
     */
