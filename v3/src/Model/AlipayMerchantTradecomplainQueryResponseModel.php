...
class AlipayMerchantTradecomplainQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets status
     *
     * @param string|null $status 状态  待处理：MERCHANT_PROCESSING  已处理：MERCHANT_FEEDBACKED  投诉完结：FINISHED  投诉关闭：CANCELLED  客服处理中：PLATFORM_PROCESSING  客服处理完结：PLATFORM_FINISH  投诉关闭：CLOSED
     *
     * @return self
     */
     ...
     * Sets targetType
     *
     * @param string|null $targetType 应用类型 例如小程序：APPID 生活号：PUBLICID 商家账户：PID
     *
     * @return self
     */
