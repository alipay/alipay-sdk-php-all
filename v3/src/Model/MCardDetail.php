 ...
 */
class MCardDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MCardDetail';
     ...
     *
     * @param string|null $availableAmount 储值卡可用余额
     *
     * @return self
     */
     ...
     * Sets payAmount
     *
     * @param string|null $payAmount 储值卡支付金额
     *
     * @return self
     */
