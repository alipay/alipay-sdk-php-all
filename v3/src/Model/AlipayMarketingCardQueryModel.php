...
class AlipayMarketingCardQueryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets targetCardNo
     *
     * @param string|null $targetCardNo 操作卡号。 若target_card_no_type为 BIZ_CARD，则该值为业务卡号，即alipay.marketing.card.open(会员卡开卡)返回结果中的card_info#biz_card_no。 若target_card_no_type为 D_QR_CODE 或D_BAR_CODE，则该值为动态码值。
     *
     * @return self
     */
     ...
     *
     * @param string|null $targetCardNoType 卡号ID类型（会员卡查询，只能提供支付宝端的卡号）  BIZ_CARD：支付宝卡号  D_QR_CODE：动态二维码（业务卡号对应的）  D_BAR_CODE：动态条码（业务卡号对应的）
     *
     * @return self
     */
