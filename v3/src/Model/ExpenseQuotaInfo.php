...
class ExpenseQuotaInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets ownerId
     *
     * @param string|null $ownerId 切换open_id前请使用：额度所属者ID owner_type为EMPLOYEE时为员工支付宝ID owner_type为ENTERPRISE_PAY_UID时为员工企业码ID owner_type为PHONE时为员工手机号 owner_type为ENTERPRISE时为企业ID
     *
     * @return self
     */
     ...
     * Sets ownerType
     *
     * @param string|null $ownerType 额度所属者id类型 EMPLOYEE 员工
     *
     * @return self
     */
     ...
     * Sets targetType
     *
     * @param string|null $targetType 额度维度 枚举值： EXPENSE_TYPE（费用类型维度）， RULE_GROUP_AGGREGATION（规则聚合维度）, INSTITUTION（制度）
     *
     * @return self
     */
