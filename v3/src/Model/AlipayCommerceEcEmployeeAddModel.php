...
class AlipayCommerceEcEmployeeAddModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets employeeCertNo
     *
     * @param string|null $employeeCertNo 证件号码，根据employee_cert_type指定的证件类型，传入对应的证件号码，可用于企业人脸库员工刷脸开通时的核验。
     *
     * @return self
     */
     ...
     *
     * @param string|null $employeeCertType 证件类型，目前仅支持身份证，可用于企业人脸库员工刷脸开通时的核验
     *
     * @return self
     */
     ...
     * Sets roleList
     *
     * @param string[]|null $roleList 默认角色列表，目前只支持默认为 USER
     *
     * @return self
     */
     ...
     *
     * @param string|null $withholdingSignStr 代扣签约字符串，需调支付宝个人协议页面签约接口，并按规则生成，见 <a href='https://opendocs.alipay.com/pre-open/20170601105911096277new/moiixx?pathHash=10b1fa66'>参考文档</a> 3.1.3 生成签约字符串示例
     *
     * @return self
     */
