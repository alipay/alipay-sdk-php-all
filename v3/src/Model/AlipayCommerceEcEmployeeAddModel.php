...
class AlipayCommerceEcEmployeeAddModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        'accountingEntityIds' => 'accounting_entity_ids',
    ...
    protected static $setters = [
        'accountingEntityIds' => 'setAccountingEntityIds',
    ...
    protected static $getters = [
        'accountingEntityIds' => 'getAccountingEntityIds',
    ...
    {
        $this->container['accountingEntityIds'] = $data['accountingEntityIds'] ?? null;
        ...
        $this->container['labelNames'] = $data['labelNames'] ?? null;
    ...
    /**
     * Gets accountingEntityIds
     *
     * @return string[]|null
     */
    public function getAccountingEntityIds()
    {
        return $this->container['accountingEntityIds'];
    }

    /**
     * Sets accountingEntityIds
     *
     * @param string[]|null $accountingEntityIds 员工所属核算主体，核算主体可用于管控不同员工的出资方式，建议和不同出资账户关联
     *
     * @return self
     */
    public function setAccountingEntityIds($accountingEntityIds)
    {
        $this->container['accountingEntityIds'] = $accountingEntityIds;
     ...
     * Sets labelNames
     *
     * @param string[]|null $labelNames 员工标签，用于员工的打标分类，后续费控管理可使用标签进行控制，支持输入多个标签，如“差旅员工，用餐员工”等；若企业需要将离职员工统一管理且不变更员工状态，可打标“离职员工”
     *
     * @return self
     */
