...
class AlipayCommerceEcEmployeeAddModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $employeeCertType 证件类型，用于企业人脸库员工刷脸开通时的核验， 枚举支持：IDENTITY_CARD身份证，PASS_PORT护照，STU_NUM学生学号，COMPANY_NUM工号，TAIWAN_CARD台胞证，HK_MC_CARD港澳证件
     *
     * @return self
     */
     ...
     * Sets iotCheckType
     *
     * @param string|null $iotCheckType 员工刷脸加入企业人脸库时的核验方式，如果设置为business_facepay_checkall，则employee_name、employee_cert_type、employee_cert_no必传，如果不传则默认不核验。
     *
     * @return self
     */
     ...
     * Sets iotVid
     *
     * @param string|null $iotVid 员工在企业人脸库的人脸唯一标识，支持自定义传入，如果未传入则会默认生成
     *
     * @return self
     */
     ...
     * Sets roleList
     *
     * @param string[]|null $roleList 角色列表，目前只支持填一种角色，默认为USER USER：普通员工 ADMIN：管理员
     *
     * @return self
     */
