...
class RefundGoodsDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets outItemId
     *
     * @param string|null $outItemId 商家侧小程序商品ID，具体使用方式请参考：https://opendocs.alipay.com/pre-open/06uila?pathHash=87297d0a
     *
     * @return self
     */
     ...
     * Sets outSkuId
     *
     * @param string|null $outSkuId 商家侧小程序商品sku ID，具体使用方式请参考：https://opendocs.alipay.com/pre-open/06uila?pathHash=87297d0a
     *
     * @return self
     */
