...
class InvoiceItemOpenModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $itemExTaxAmount 明细行不含税金额，保留两位小数
     *
     * @return self
     */
     ...
     * Sets itemSumAmount
     *
     * @param string|null $itemSumAmount 明细行价税合计，必须保证item_sum_amount=item_ex_tax_amount+item_tax_amount。
     *
     * @return self
     */
     ...
     * Sets itemTaxAmount
     *
     * @param string|null $itemTaxAmount 明细行税额，保留两位小数，无税或者免税情况下输入：0.00。
     *
     * @return self
     */
     ...
     * Sets itemUnitPrice
     *
     * @param string|null $itemUnitPrice 不含税单价; 1.当row_type=0或2且item_quantity为空，可空 2.可精确到小数点后8位；
     *
     * @return self
     */
