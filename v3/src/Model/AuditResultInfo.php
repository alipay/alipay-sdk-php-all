...
/**
 * AuditResultInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AuditResultInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuditResultInfo';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['auditResult'] = $data['auditResult'] ?? null;
     ...
     * Sets auditReason
     *
     * @param string|null $auditReason 审核驳回的原因
     *
     * @return self
     */
     ...
     * Sets auditResult
     *
     * @param string|null $auditResult 审核结果 SUBMIT：审核中 APPROVE：审核通过 REJECT：审核驳回
     *
     * @return self
     */
     ...
     * Sets auditType
     *
     * @param string|null $auditType 审核类型 UNIFY_ACCESS_CHECK：统一接入平台审核
     *
     * @return self
     */
