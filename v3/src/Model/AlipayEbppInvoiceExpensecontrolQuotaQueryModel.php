...
class AlipayEbppInvoiceExpensecontrolQuotaQueryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets ownerId
     *
     * @param string|null $ownerId 切换open_id前请使用：额度所属者ID owner_type为EMPLOYEE时为员工支付宝ID owner_type为PHONE时为员工手机号 owner_type为ENTERPRISE_PAY_UID时为员工企业码ID
     *
     * @return self
     */
     ...
     * Sets ownerOpenId
     *
     * @param string|null $ownerOpenId 切换open_id后请使用：额度所属者ID owner_type为EMPLOYEE时为员工open_id owner_type为PHONE时为员工手机号 owner_type为ENTERPRISE_PAY_UID时为员工企业码ID
     *
     * @return self
     */
     ...
     * Sets ownerType
     *
     * @param string|null $ownerType 额度所属者类型 EMPLOYEE 员工
     *
     * @return self
     */
     ...
     * Sets pageSize
     *
     * @param int|null $pageSize 每页条数，限制20
     *
     * @return self
     */
     ...
     * Sets quotaIdList
     *
     * @param string[]|null $quotaIdList 额度ID 特殊说明：最多传入10个quota_id
     *
     * @return self
     */
     ...
     * Sets targetId
     *
     * @param string|null $targetId 额度维度ID 当 target_type=EXPENSE_TYPE 时，值为 MEAL（工作餐） 当target_type=RULE_GROUP_AGGREGATION 时，值为费控规则聚合ID 当target_type=INSTITUTION 时，值为制度ID，target_type和target_id要正确对应，否则会导致查不到额度。
     *
     * @return self
     */
