...
class DatadigitalFincloudGeneralsaasFaceCertifyInitializeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets identityParam
     *
     * @param string|null $identityParam 需要验证的身份信息(json)字段说明如下： identity_type： 身份信息参数类型，固定为 CERT_INFO cert_name：真实姓名，必填 cert_no：证件号码，必填 phone_no：手机号码，选填 cert_type：证件类型，必填，枚举支持： IDENTITY_CARD：身份证
     *
     * @return self
     */
     ...
     * Sets merchantConfig
     *
     * @param string|null $merchantConfig 商户个性化配置，格式为json，详细支持的字段说明为： return_url：需要回跳的目标地址，必填，一般指定为商户业务页面 face_reserve_strategy：人脸保存策略，非必填；reserve(保存活体人脸)/never(不保存活体人脸)，不传默认为reserve
     *
     * @return self
     */
