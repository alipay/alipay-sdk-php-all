...
class EnterpriseInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets activate
     *
     * @param string|null $activate 因公签约状态 UNACTIVATED:未激活 ACTIVATED:已激活 说明：表示签约资金因公付
     *
     * @return self
     */
     ...
     * Sets authLevel
     *
     * @param string|null $authLevel 企业认证等级 10初级认证  30 高级认证
     *
     * @return self
     */
     ...
     * Sets authStatus
     *
     * @param string|null $authStatus 认证状态  NO_AUTH：未认证 IN_AUTH：认证中 HAS_AUTH：已认证
     *
     * @return self
     */
     ...
     *
     * @param string|null $enterpriseAlias 企业名称
     *
     * @return self
     */
     ...
     * Sets signStatus
     *
     * @param string|null $signStatus 企业服务协议状态 UNSIGNED:未签约 SIGNED:已签约 TERMINATED:已解约 说明：表示签约企业码服务协议
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status 企业当前状态 SYNC：数据同步中 NORMAL：正常 WITHDRAW：注销
     *
     * @return self
     */
