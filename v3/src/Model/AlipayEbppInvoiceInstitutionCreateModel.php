...
class AlipayEbppInvoiceInstitutionCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets consultMode
     *
     * @param string|null $consultMode 费控咨询模式，默认为0。 0-支付宝内部计算 1-咨询外部服务商（此模式不可创建发放规则，不可创建额度相关规则的条件，消费模式需为\"默认\"）
     *
     * @return self
     */
     ...
     * Sets enterpriseId
     *
     * @param string|null $enterpriseId 企业id（条件必填）
     *
     * @return self
     */
     ...
     *
     * @param string|null $institutionDesc 制度描述（可空）
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\IssueRuleInfo[]|null $issueRuleInfoList 发放规则列表（可空），一个制度下最多创建10条发放规则。咨询模式为“咨询外部服务商”时不可用
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\StandardInfo[]|null $standardInfoList 使用规则列表，一个制度下最多创建10条使用规则。
     *
     * @return self
     */
