...
class AlipayOpenMiniVersionAuditApplyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets appName
     *
     * @param string|null $appName 小程序名称，长度限制 3~30 个字符（中文字符按2个字符计算），仅支持包含中文、数字、英文、下划线、+、-。 如果不填默认采用当前小程序应用名称，如无默认值则必填，不可为空。
     *
     * @return self
     */
     ...
     * Sets licenseName
     *
     * @param string|null $licenseName 营业执照名称，参照https://opendocs.alipay.com/mini/operation/material 要求填写营业执照信息。
     *
     * @return self
     */
     ...
     * Sets licenseNo
     *
     * @param string|null $licenseNo 营业执照证件号，部分小程序类目需要提交，可通过https://opendocs.alipay.com/mini/03l8c8 查询类目是否需要上传营业执照信息。参照https://opendocs.alipay.com/mini/operation/material 要求填写营业执照信息。
     *
     * @return self
     */
     ...
     *
     * @param string|null $miniCategoryIds 新小程序前台类目，格式为 第一个一级类目_第一个二级类目;第二个一级类目_第二个二级类目_第二个三级类目，详细类目可以通过 https://docs.open.alipay.com/api_49/alipay.open.mini.category.query 接口查询mini_category_list。
     *
     * @return self
     */
