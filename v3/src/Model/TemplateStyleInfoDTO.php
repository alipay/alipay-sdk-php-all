...
class TemplateStyleInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets bannerImgId
     *
     * @param string|null $bannerImgId banner图片地址。 通过接口（alipay.offline.material.image.upload）上传图片。
     *
     * @return self
     */
     ...
     * Sets cardShowName
     *
     * @param string|null $cardShowName 钱包端显示名称（字符串长度）
     *
     * @return self
     */
     ...
     * Sets color
     *
     * @param string|null $color 注意：此字段已废弃。  卡片颜色
     *
     * @return self
     */
     ...
     *
     * @param string|null $columnInfoLayout 栏位信息布局。目前只支持list（列表）或grid（宫格）形式。如果为空则默认为list。
     *
     * @return self
     */
     ...
     * Sets sloganImgId
     *
     * @param string|null $sloganImgId 标语图片， 通过接口（alipay.offline.material.image.upload）上传图片
     *
     * @return self
     */
