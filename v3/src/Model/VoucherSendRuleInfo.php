...
class VoucherSendRuleInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'quantity' => 'int',
        'quantityDayLimitPerUser' => 'int',
        'quantityLimitPerUser' => 'int',
        'quantityLimitPerUserPeriodType' => 'string',
        'quantityMonthLimitPerUser' => 'int',
        'quantityWeekLimitPerUser' => 'int',
        'realNameLimit' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'quantity' => null,
        'quantityDayLimitPerUser' => null,
        'quantityLimitPerUser' => null,
        'quantityLimitPerUserPeriodType' => null,
        'quantityMonthLimitPerUser' => null,
        'quantityWeekLimitPerUser' => null,
        'realNameLimit' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'quantity' => 'quantity',
        'quantityDayLimitPerUser' => 'quantity_day_limit_per_user',
        'quantityLimitPerUser' => 'quantity_limit_per_user',
        'quantityLimitPerUserPeriodType' => 'quantity_limit_per_user_period_type',
        'quantityMonthLimitPerUser' => 'quantity_month_limit_per_user',
        'quantityWeekLimitPerUser' => 'quantity_week_limit_per_user',
    ...
    protected static $setters = [
        ...
        'quantityDayLimitPerUser' => 'setQuantityDayLimitPerUser',
        'quantityLimitPerUser' => 'setQuantityLimitPerUser',
        'quantityLimitPerUserPeriodType' => 'setQuantityLimitPerUserPeriodType',
        'quantityMonthLimitPerUser' => 'setQuantityMonthLimitPerUser',
        'quantityWeekLimitPerUser' => 'setQuantityWeekLimitPerUser',
    ...
    protected static $getters = [
        ...
        'quantityDayLimitPerUser' => 'getQuantityDayLimitPerUser',
        'quantityLimitPerUser' => 'getQuantityLimitPerUser',
        'quantityLimitPerUserPeriodType' => 'getQuantityLimitPerUserPeriodType',
        'quantityMonthLimitPerUser' => 'getQuantityMonthLimitPerUser',
        'quantityWeekLimitPerUser' => 'getQuantityWeekLimitPerUser',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['quantityDayLimitPerUser'] = $data['quantityDayLimitPerUser'] ?? null;
        ...
        $this->container['quantityMonthLimitPerUser'] = $data['quantityMonthLimitPerUser'] ?? null;
        $this->container['quantityWeekLimitPerUser'] = $data['quantityWeekLimitPerUser'] ?? null;
    ...
    /**
     * Gets quantityDayLimitPerUser
     *
     * @return int|null
     */
    public function getQuantityDayLimitPerUser()
    {
        return $this->container['quantityDayLimitPerUser'];
    }

    /**
     * Sets quantityDayLimitPerUser
     *
     * @param int|null $quantityDayLimitPerUser 每人每日可领取数量限制，填0或者不填表示不限制。
     *
     * @return self
     */
    public function setQuantityDayLimitPerUser($quantityDayLimitPerUser)
    {
        $this->container['quantityDayLimitPerUser'] = $quantityDayLimitPerUser;
    ...
    /**
     * Gets quantityMonthLimitPerUser
     *
     * @return int|null
     */
    public function getQuantityMonthLimitPerUser()
    {
        return $this->container['quantityMonthLimitPerUser'];
    }

    /**
     * Sets quantityMonthLimitPerUser
     *
     * @param int|null $quantityMonthLimitPerUser 每人每月可领取数量限制，填0或者不填表示不限制
     *
     * @return self
     */
    public function setQuantityMonthLimitPerUser($quantityMonthLimitPerUser)
    {
        $this->container['quantityMonthLimitPerUser'] = $quantityMonthLimitPerUser;

        return $this;
    }

    /**
     * Gets quantityWeekLimitPerUser
     *
     * @return int|null
     */
    public function getQuantityWeekLimitPerUser()
    {
        return $this->container['quantityWeekLimitPerUser'];
    }

    /**
     * Sets quantityWeekLimitPerUser
     *
     * @param int|null $quantityWeekLimitPerUser 每人每周可领取数量限制，填0或者不填表示不限制
     *
     * @return self
     */
    public function setQuantityWeekLimitPerUser($quantityWeekLimitPerUser)
    {
        $this->container['quantityWeekLimitPerUser'] = $quantityWeekLimitPerUser;
