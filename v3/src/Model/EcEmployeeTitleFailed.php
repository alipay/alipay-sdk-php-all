...
/**
 * EcEmployeeTitleFailed Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class EcEmployeeTitleFailed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EcEmployeeTitleFailed';
     ...
     * Sets message
     *
     * @param string|null $message 返回每一个抬头批量处理信息
     *
     * @return self
     */
     ...
     * Sets titleTag
     *
     * @param string|null $titleTag 标识抬头是否默认DEFAULT/多抬头MULTI
     *
     * @return self
     */
