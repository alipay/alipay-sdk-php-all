...
class EcConsumeInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'peerPayerCardName' => 'peer_payer_card_name',
    ...
    protected static $setters = [
        ...
        'peerPayerCardName' => 'setPeerPayerCardName',
    ...
    protected static $getters = [
        ...
        'peerPayerCardName' => 'getPeerPayerCardName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['peerPayerCardName'] = $data['peerPayerCardName'] ?? null;
     ...
     *
     * @param string|null $expenseSceneCode 费用场景/一级场景
     *
     * @return self
     */
     ...
     *
     * @param string|null $expenseTypeSubCategory 费用类型子类目/二级场景
     *
     * @return self
     */
     ...
     * Sets extInfos
     *
     * @param string|null $extInfos 账单扩展信息，JsonMap格式，以下信息可组合返回，\"SUMMARY_INFO\"表示\"账单汇总信息\"，\"MERCHANT_EXTEND_INFO\"表示\"商户信息\"，\"TERMINAL_INFO\"表示\"终端设备信息\"，\"BENEFIT_INFO\"表示\"员工优惠信息\"，\"CONSUMPTION_LOCATION\"表示\"消费上报位置\"，\"THIRD_PARTY_PAYMENT_INFO\"表示\"代收款详情\"，\"REIMBURSEMENT_INFO\"表示\"审批单信息\"
     *
     * @return self
     */
    ...
    /**
     * Gets peerPayerCardName
     *
     * @return string|null
     */
    public function getPeerPayerCardName()
    {
        return $this->container['peerPayerCardName'];
    }

    /**
     * Sets peerPayerCardName
     *
     * @param string|null $peerPayerCardName 实际出资人名称
     *
     * @return self
     */
    public function setPeerPayerCardName($peerPayerCardName)
    {
        $this->container['peerPayerCardName'] = $peerPayerCardName;
