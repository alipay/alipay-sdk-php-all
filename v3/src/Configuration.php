...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/3.0.16/PHP';
     ...
     * @var string
     */
    protected $sdkVersion = 'OpenAPI-Generator/3.0.16/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2024-10-08' . PHP_EOL;
