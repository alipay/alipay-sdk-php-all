...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://openapi.alipay.com';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/3.0.95/PHP';
     ...
     * @var string
     */
    protected $sdkVersion = 'OpenAPI-Generator/3.0.95/PHP';
    ...
    {
        $report  = 'PHP SDK (Alipay\OpenAPISDK) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2026-08-26' . PHP_EOL;
        $report .= '    SDK Package Version: 3.0.95' . PHP_EOL;
