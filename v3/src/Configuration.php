...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/3.0.20/PHP';
     ...
     * @var string
     */
    protected $sdkVersion = 'OpenAPI-Generator/3.0.20/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2024-11-12' . PHP_EOL;
