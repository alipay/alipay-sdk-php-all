...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2.3.17/PHP';
     ...
     * @var string
     */
    protected $sdkVersion = 'OpenAPI-Generator/2.3.17/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2023-10-25' . PHP_EOL;
        $report .= '    SDK Package Version: 2.3.17' . PHP_EOL;
