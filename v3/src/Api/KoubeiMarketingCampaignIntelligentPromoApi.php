...
/**
 * KoubeiMarketingCampaignIntelligentPromoApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class KoubeiMarketingCampaignIntelligentPromoApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 智能营销活动批量查询
     *
     * @param  \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryModel $koubeiMarketingCampaignIntelligentPromoBatchqueryModel koubeiMarketingCampaignIntelligentPromoBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryDefaultResponse
     */
    public function batchquery($koubeiMarketingCampaignIntelligentPromoBatchqueryModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($koubeiMarketingCampaignIntelligentPromoBatchqueryModel, $customizedParams);
        return $response;
    }
     ...
     * 智能营销活动批量查询
     *
     * @param  \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryModel $koubeiMarketingCampaignIntelligentPromoBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchqueryWithHttpInfo($koubeiMarketingCampaignIntelligentPromoBatchqueryModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($koubeiMarketingCampaignIntelligentPromoBatchqueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     */
    public function batchqueryAsync($koubeiMarketingCampaignIntelligentPromoBatchqueryModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($koubeiMarketingCampaignIntelligentPromoBatchqueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function batchqueryAsyncWithHttpInfo($koubeiMarketingCampaignIntelligentPromoBatchqueryModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentPromoBatchqueryResponseModel';
        $request = $this->batchqueryRequest($koubeiMarketingCampaignIntelligentPromoBatchqueryModel, $customizedParams);
     ...
     */
    public function batchqueryRequest($koubeiMarketingCampaignIntelligentPromoBatchqueryModel = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/koubei/marketing/campaign/intelligent/promo/batchquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($koubeiMarketingCampaignIntelligentPromoBatchqueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($koubeiMarketingCampaignIntelligentPromoBatchqueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $koubeiMarketingCampaignIntelligentPromoBatchqueryModel;
            }
