...
/**
 * AlipayEbppInvoiceExpensecontrolEmployeequotaApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceExpensecontrolEmployeequotaApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 创建余额（特定场景）
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateModel $alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateDefaultResponse
     */
    public function create($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->createWithHttpInfo($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel, $customizedParams);
        return $response;
    }
     ...
     * 创建余额（特定场景）
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateModel $alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->createRequest($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     */
    public function createAsync($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->createAsyncWithHttpInfo($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecontrolEmployeequotaCreateResponseModel';
        $request = $this->createRequest($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel, $customizedParams);
     ...
     */
    public function createRequest($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/expensecontrol/employeequota/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEbppInvoiceExpensecontrolEmployeequotaCreateModel;
            }
