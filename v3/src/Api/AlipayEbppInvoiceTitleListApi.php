...
class AlipayEbppInvoiceTitleListApi
{
     ...
     */
    public function get($authToken = null, $userId = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->getWithHttpInfo($authToken, $userId, $customizedParams);
        return $response;
    }
     ...
     */
    public function getWithHttpInfo($authToken = null, $userId = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->getRequest($authToken, $userId, $customizedParams);
     ...
     */
    public function getAsync($authToken = null, $userId = null, CustomizedParams $customizedParams = null)
    {
        return $this->getAsyncWithHttpInfo($authToken, $userId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAsyncWithHttpInfo($authToken = null, $userId = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetResponseModel';
        $request = $this->getRequest($authToken, $userId, $customizedParams);
     ...
     */
    public function getRequest($authToken = null, $userId = null, CustomizedParams $customizedParams = null)
    {
