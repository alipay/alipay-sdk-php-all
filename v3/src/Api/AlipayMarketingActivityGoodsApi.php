...
class AlipayMarketingActivityGoodsApi
{
     ...
     * @param  string $merchantId 商户PID,默认为当前接口调用商户  限制:  接口调用者必须有商户代运营权限。   代运营授权流程https://opendocs.alipay.com/mini/01hm6i#%E4%BB%A3%E8%BF%90%E8%90%A5%E6%8E%88%E6%9D%83 (optional)
     * @param  string $goodsUseType 活动单品类型。 枚举值: AVAILABLE 可用商品 UNAVAILABLE 不可用商品 (optional)
     ...
     * @param  string $merchantAccessMode 商户接入模式  枚举值 SELF_MODE 商户自接入模式 AGENCY_MODE 服务商代接入模式 (optional)
