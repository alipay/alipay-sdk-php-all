...
/**
 * KoubeiMarketingCampaignIntelligentShopApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class KoubeiMarketingCampaignIntelligentShopApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 智能营销门店咨询
     *
     * @param  \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultModel $koubeiMarketingCampaignIntelligentShopConsultModel koubeiMarketingCampaignIntelligentShopConsultModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultResponseModel|\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultDefaultResponse
     */
    public function consult($koubeiMarketingCampaignIntelligentShopConsultModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->consultWithHttpInfo($koubeiMarketingCampaignIntelligentShopConsultModel, $customizedParams);
        return $response;
    }
     ...
     * 智能营销门店咨询
     *
     * @param  \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultModel $koubeiMarketingCampaignIntelligentShopConsultModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultResponseModel|\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultWithHttpInfo($koubeiMarketingCampaignIntelligentShopConsultModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->consultRequest($koubeiMarketingCampaignIntelligentShopConsultModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     */
    public function consultAsync($koubeiMarketingCampaignIntelligentShopConsultModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->consultAsyncWithHttpInfo($koubeiMarketingCampaignIntelligentShopConsultModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function consultAsyncWithHttpInfo($koubeiMarketingCampaignIntelligentShopConsultModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentShopConsultResponseModel';
        $request = $this->consultRequest($koubeiMarketingCampaignIntelligentShopConsultModel, $customizedParams);
     ...
     */
    public function consultRequest($koubeiMarketingCampaignIntelligentShopConsultModel = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/koubei/marketing/campaign/intelligent/shop/consult';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($koubeiMarketingCampaignIntelligentShopConsultModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($koubeiMarketingCampaignIntelligentShopConsultModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $koubeiMarketingCampaignIntelligentShopConsultModel;
            }
