...
/**
 * AlipayBossProdMyTestApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayBossProdMyTestApi
{
     ...
     * 明焕open测试
     *
     * @param  string $areaCode 区. (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryDefaultResponse
     */
    public function query($areaCode = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($areaCode, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($areaCode = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($areaCode, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     */
    public function queryAsync($areaCode = null, CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($areaCode, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsyncWithHttpInfo($areaCode = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayBossProdMyTestQueryResponseModel';
        $request = $this->queryRequest($areaCode, $customizedParams);
     ...
     */
    public function queryRequest($areaCode = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/boss/prod/my/test/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
