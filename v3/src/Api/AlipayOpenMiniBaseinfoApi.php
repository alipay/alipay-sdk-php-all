...
class AlipayOpenMiniBaseinfoApi
{
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoModifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoModifyDefaultResponse
     */
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoModifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoModifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyWithHttpInfo($appLogo = null, $data = null, CustomizedParams $customizedParams = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoModifyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoModifyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoModifyResponseModel', []),
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoModifyResponseModel';
