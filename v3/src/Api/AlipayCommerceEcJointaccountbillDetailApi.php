...
class AlipayCommerceEcJointaccountbillDetailApi
{
     ...
     * @param  string $pageNum 页数。本参数为空或小于1默认显示第一页；如果输入的值大于总页数，则返回最后一页数据。 (optional)
     * @param  string $pageSize 每页大小。本参数为空或小于1默认20条；超过20条默认按20条查询；不足20条则按实际记录数返回。 (optional)
     * @param  string $startDate 起始日期。支持yyyy-MM-dd和yyyy-MM-dd HH:mm:ss两种格式 (optional)
     * @param  string $endDate 截止日期。支持yyyy-MM-dd和yyyy-MM-dd HH:mm:ss两种格式 (optional)
     ...
     */
    public function batchquery($enterpriseId = null, $bizScene = null, $userId = null, $openId = null, $pageNum = null, $pageSize = null, $startDate = null, $endDate = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($enterpriseId, $bizScene, $userId, $openId, $pageNum, $pageSize, $startDate, $endDate, $customizedParams);
        return $response;
    }
     ...
     */
    public function batchqueryWithHttpInfo($enterpriseId = null, $bizScene = null, $userId = null, $openId = null, $pageNum = null, $pageSize = null, $startDate = null, $endDate = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($enterpriseId, $bizScene, $userId, $openId, $pageNum, $pageSize, $startDate, $endDate, $customizedParams);
     ...
     */
    public function batchqueryAsync($enterpriseId = null, $bizScene = null, $userId = null, $openId = null, $pageNum = null, $pageSize = null, $startDate = null, $endDate = null, CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($enterpriseId, $bizScene, $userId, $openId, $pageNum, $pageSize, $startDate, $endDate, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function batchqueryAsyncWithHttpInfo($enterpriseId = null, $bizScene = null, $userId = null, $openId = null, $pageNum = null, $pageSize = null, $startDate = null, $endDate = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryResponseModel';
        $request = $this->batchqueryRequest($enterpriseId, $bizScene, $userId, $openId, $pageNum, $pageSize, $startDate, $endDate, $customizedParams);
     ...
     */
    public function batchqueryRequest($enterpriseId = null, $bizScene = null, $userId = null, $openId = null, $pageNum = null, $pageSize = null, $startDate = null, $endDate = null, CustomizedParams $customizedParams = null)
    {
