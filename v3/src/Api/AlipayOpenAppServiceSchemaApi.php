...
class AlipayOpenAppServiceSchemaApi
{
     ...
     * 服务schema下发
     *
     * @param  string $categoryId 类目id (optional)
     ...
     */
    public function query($categoryId = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($categoryId, $customizedParams);
        return $response;
    }
     ...
     */
    public function queryWithHttpInfo($categoryId = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($categoryId, $customizedParams);
     ...
     */
    public function queryAsync($categoryId = null, CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($categoryId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsyncWithHttpInfo($categoryId = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceSchemaQueryResponseModel';
        $request = $this->queryRequest($categoryId, $customizedParams);
     ...
     */
    public function queryRequest($categoryId = null, CustomizedParams $customizedParams = null)
    {
