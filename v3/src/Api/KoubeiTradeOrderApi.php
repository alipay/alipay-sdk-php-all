...
/**
 * KoubeiTradeOrderApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class KoubeiTradeOrderApi
{
     ...
     * 口碑订单预咨询
     *
     * @param  \Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultModel $koubeiTradeOrderConsultModel koubeiTradeOrderConsultModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultResponseModel|\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultDefaultResponse
     */
    public function consult($koubeiTradeOrderConsultModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->consultWithHttpInfo($koubeiTradeOrderConsultModel, $customizedParams);
        return $response;
    }
     ...
     * 口碑订单预咨询
     *
     * @param  \Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultModel $koubeiTradeOrderConsultModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultResponseModel|\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultWithHttpInfo($koubeiTradeOrderConsultModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->consultRequest($koubeiTradeOrderConsultModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     */
    public function consultAsync($koubeiTradeOrderConsultModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->consultAsyncWithHttpInfo($koubeiTradeOrderConsultModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function consultAsyncWithHttpInfo($koubeiTradeOrderConsultModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\KoubeiTradeOrderConsultResponseModel';
        $request = $this->consultRequest($koubeiTradeOrderConsultModel, $customizedParams);
     ...
     */
    public function consultRequest($koubeiTradeOrderConsultModel = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/koubei/trade/order/consult';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($koubeiTradeOrderConsultModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($koubeiTradeOrderConsultModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $koubeiTradeOrderConsultModel;
            }
