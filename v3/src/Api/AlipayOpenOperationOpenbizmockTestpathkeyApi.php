...
class AlipayOpenOperationOpenbizmockTestpathkeyApi
{
     ...
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenOperationOpenbizmockTestpathkeyQueryModel $alipayOpenOperationOpenbizmockTestpathkeyQueryModel alipayOpenOperationOpenbizmockTestpathkeyQueryModel (optional)
     ...
     */
    public function query($keykey, $a, $b = null, $c = null, $alipayOpenOperationOpenbizmockTestpathkeyQueryModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($keykey, $a, $b, $c, $alipayOpenOperationOpenbizmockTestpathkeyQueryModel, $customizedParams);
        return $response;
    }
     ...
     * @param  string $b ceshi (optional)
     * @param  string $c 测试 (optional)
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenOperationOpenbizmockTestpathkeyQueryModel $alipayOpenOperationOpenbizmockTestpathkeyQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function queryWithHttpInfo($keykey, $a, $b = null, $c = null, $alipayOpenOperationOpenbizmockTestpathkeyQueryModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($keykey, $a, $b, $c, $alipayOpenOperationOpenbizmockTestpathkeyQueryModel, $customizedParams);
     ...
     */
    public function queryAsync($keykey, $a, $b = null, $c = null, $alipayOpenOperationOpenbizmockTestpathkeyQueryModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($keykey, $a, $b, $c, $alipayOpenOperationOpenbizmockTestpathkeyQueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsyncWithHttpInfo($keykey, $a, $b = null, $c = null, $alipayOpenOperationOpenbizmockTestpathkeyQueryModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenOperationOpenbizmockTestpathkeyQueryResponseModel';
        $request = $this->queryRequest($keykey, $a, $b, $c, $alipayOpenOperationOpenbizmockTestpathkeyQueryModel, $customizedParams);
     ...
     */
    public function queryRequest($keykey, $a, $b = null, $c = null, $alipayOpenOperationOpenbizmockTestpathkeyQueryModel = null, CustomizedParams $customizedParams = null)
    {
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenOperationOpenbizmockTestpathkeyQueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenOperationOpenbizmockTestpathkeyQueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenOperationOpenbizmockTestpathkeyQueryModel;
            }
