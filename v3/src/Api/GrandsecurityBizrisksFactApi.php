...
/**
 * GrandsecurityBizrisksFactApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GrandsecurityBizrisksFactApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 事实核查服务
     *
     * @param  \Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckModel $grandsecurityBizrisksFactCheckModel grandsecurityBizrisksFactCheckModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckResponseModel|\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckDefaultResponse
     */
    public function check($grandsecurityBizrisksFactCheckModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->checkWithHttpInfo($grandsecurityBizrisksFactCheckModel, $customizedParams);
        return $response;
    }
     ...
     * 事实核查服务
     *
     * @param  \Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckModel $grandsecurityBizrisksFactCheckModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckResponseModel|\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function checkWithHttpInfo($grandsecurityBizrisksFactCheckModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->checkRequest($grandsecurityBizrisksFactCheckModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function checkAsync($grandsecurityBizrisksFactCheckModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->checkAsyncWithHttpInfo($grandsecurityBizrisksFactCheckModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function checkAsyncWithHttpInfo($grandsecurityBizrisksFactCheckModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\GrandsecurityBizrisksFactCheckResponseModel';
        $request = $this->checkRequest($grandsecurityBizrisksFactCheckModel, $customizedParams);
     ...
     */
    public function checkRequest($grandsecurityBizrisksFactCheckModel = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/stream/grandsecurity/bizrisks/fact/check';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($grandsecurityBizrisksFactCheckModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($grandsecurityBizrisksFactCheckModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $grandsecurityBizrisksFactCheckModel;
            }
