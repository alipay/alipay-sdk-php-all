...
class AntMerchantExpandOrderApi
{
     ...
     * 商户申请单查询
     *
     * @param  string $orderId 申请单 id。 1.蚂蚁门店管理场景：通过 &lt;a href&#x3D;\&quot;https://opendocs.alipay.com/open/05afbc4a_ant.merchant.expand.shop.create?scene&#x3D;common&amp;pathHash&#x3D;bf443b73\&quot;&gt; ant.merchant.expand.shop.create&lt;/a&gt;(蚂蚁门店创建)接口进件时返回的order_id。 2.直付通二级商户进件场景：通过&lt;a href&#x3D;\&quot;https://opendocs.alipay.com/open/028xr0?pathHash&#x3D;c9ca6d68\&quot;&gt;ant.merchant.expand.indirect.zft.create&lt;/a&gt;(直付通二级商户创建)接口进件时返回的order_id。 (required)
     * @param  string $bizSource 业务来源 团购门店：APLUS_SHOP (optional)
     ...
     */
    public function query($orderId, $bizSource = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($orderId, $bizSource, $customizedParams);
        return $response;
    }
     ...
     */
    public function queryWithHttpInfo($orderId, $bizSource = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($orderId, $bizSource, $customizedParams);
     ...
     * @deprecated
     */
    public function queryAsync($orderId, $bizSource = null, CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($orderId, $bizSource, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($orderId, $bizSource = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AntMerchantExpandOrderQueryResponseModel';
        $request = $this->queryRequest($orderId, $bizSource, $customizedParams);
     ...
     */
    public function queryRequest($orderId, $bizSource = null, CustomizedParams $customizedParams = null)
    {
