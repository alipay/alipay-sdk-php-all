...
/**
 * AnttechOceanbaseTestplatformTaskApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AnttechOceanbaseTestplatformTaskApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 获取ob开源官网提测平台待执行任务接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryModel $anttechOceanbaseTestplatformTaskQueryModel anttechOceanbaseTestplatformTaskQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryResponseModel|\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryDefaultResponse
     */
    public function query($anttechOceanbaseTestplatformTaskQueryModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($anttechOceanbaseTestplatformTaskQueryModel, $customizedParams);
        return $response;
    }
     ...
     * 获取ob开源官网提测平台待执行任务接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryModel $anttechOceanbaseTestplatformTaskQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryResponseModel|\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($anttechOceanbaseTestplatformTaskQueryModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($anttechOceanbaseTestplatformTaskQueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     */
    public function queryAsync($anttechOceanbaseTestplatformTaskQueryModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($anttechOceanbaseTestplatformTaskQueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsyncWithHttpInfo($anttechOceanbaseTestplatformTaskQueryModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AnttechOceanbaseTestplatformTaskQueryResponseModel';
        $request = $this->queryRequest($anttechOceanbaseTestplatformTaskQueryModel, $customizedParams);
     ...
     */
    public function queryRequest($anttechOceanbaseTestplatformTaskQueryModel = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/anttech/oceanbase/testplatform/task/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($anttechOceanbaseTestplatformTaskQueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($anttechOceanbaseTestplatformTaskQueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $anttechOceanbaseTestplatformTaskQueryModel;
            }
