...
class AlipayEbppInvoiceInstitutionDetailinfoApi
{
     ...
     * 制度详情查询
     *
     * @param  string $accountId 企业共同账户id，和授权签约协议号共同使用。 (optional)
     * @param  string $agreementNo 授权签约协议号，可通过签约消息获取。配合企业共同账户id使用，当填写企业共同账户id时，此字段必填。 (optional)
     ...
     */
    public function query($accountId = null, $agreementNo = null, $enterpriseId = null, $institutionId = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($accountId, $agreementNo, $enterpriseId, $institutionId, $customizedParams);
        return $response;
    }
     ...
     */
    public function queryWithHttpInfo($accountId = null, $agreementNo = null, $enterpriseId = null, $institutionId = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($accountId, $agreementNo, $enterpriseId, $institutionId, $customizedParams);
     ...
     */
    public function queryAsync($accountId = null, $agreementNo = null, $enterpriseId = null, $institutionId = null, CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($accountId, $agreementNo, $enterpriseId, $institutionId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsyncWithHttpInfo($accountId = null, $agreementNo = null, $enterpriseId = null, $institutionId = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceInstitutionDetailinfoQueryResponseModel';
        $request = $this->queryRequest($accountId, $agreementNo, $enterpriseId, $institutionId, $customizedParams);
     ...
     */
    public function queryRequest($accountId = null, $agreementNo = null, $enterpriseId = null, $institutionId = null, CustomizedParams $customizedParams = null)
    {
