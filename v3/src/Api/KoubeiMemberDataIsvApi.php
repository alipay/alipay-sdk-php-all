...
/**
 * KoubeiMemberDataIsvApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class KoubeiMemberDataIsvApi
{
     ...
     * isv 会员CRM数据回流
     *
     * @param  \Alipay\OpenAPISDK\Model\KoubeiMemberDataIsvCreateModel $koubeiMemberDataIsvCreateModel koubeiMemberDataIsvCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\KoubeiMemberDataIsvCreateDefaultResponse
     */
    public function create($koubeiMemberDataIsvCreateModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->createWithHttpInfo($koubeiMemberDataIsvCreateModel, $customizedParams);
        return $response;
    }
     ...
     * isv 会员CRM数据回流
     *
     * @param  \Alipay\OpenAPISDK\Model\KoubeiMemberDataIsvCreateModel $koubeiMemberDataIsvCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\KoubeiMemberDataIsvCreateDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($koubeiMemberDataIsvCreateModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->createRequest($koubeiMemberDataIsvCreateModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\KoubeiMemberDataIsvCreateDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\KoubeiMemberDataIsvCreateDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\KoubeiMemberDataIsvCreateDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\KoubeiMemberDataIsvCreateDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     */
    public function createAsync($koubeiMemberDataIsvCreateModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->createAsyncWithHttpInfo($koubeiMemberDataIsvCreateModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($koubeiMemberDataIsvCreateModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->createRequest($koubeiMemberDataIsvCreateModel, $customizedParams);
     ...
     */
    public function createRequest($koubeiMemberDataIsvCreateModel = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/koubei/member/data/isv/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($koubeiMemberDataIsvCreateModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($koubeiMemberDataIsvCreateModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $koubeiMemberDataIsvCreateModel;
            }
