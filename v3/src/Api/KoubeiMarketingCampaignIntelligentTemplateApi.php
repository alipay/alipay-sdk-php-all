...
/**
 * KoubeiMarketingCampaignIntelligentTemplateApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class KoubeiMarketingCampaignIntelligentTemplateApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 智能营销模板咨询
     *
     * @param  \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultModel $koubeiMarketingCampaignIntelligentTemplateConsultModel koubeiMarketingCampaignIntelligentTemplateConsultModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultResponseModel|\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultDefaultResponse
     */
    public function consult($koubeiMarketingCampaignIntelligentTemplateConsultModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->consultWithHttpInfo($koubeiMarketingCampaignIntelligentTemplateConsultModel, $customizedParams);
        return $response;
    }
     ...
     * 智能营销模板咨询
     *
     * @param  \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultModel $koubeiMarketingCampaignIntelligentTemplateConsultModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultResponseModel|\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultWithHttpInfo($koubeiMarketingCampaignIntelligentTemplateConsultModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->consultRequest($koubeiMarketingCampaignIntelligentTemplateConsultModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     */
    public function consultAsync($koubeiMarketingCampaignIntelligentTemplateConsultModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->consultAsyncWithHttpInfo($koubeiMarketingCampaignIntelligentTemplateConsultModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function consultAsyncWithHttpInfo($koubeiMarketingCampaignIntelligentTemplateConsultModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\KoubeiMarketingCampaignIntelligentTemplateConsultResponseModel';
        $request = $this->consultRequest($koubeiMarketingCampaignIntelligentTemplateConsultModel, $customizedParams);
     ...
     */
    public function consultRequest($koubeiMarketingCampaignIntelligentTemplateConsultModel = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/koubei/marketing/campaign/intelligent/template/consult';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($koubeiMarketingCampaignIntelligentTemplateConsultModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($koubeiMarketingCampaignIntelligentTemplateConsultModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $koubeiMarketingCampaignIntelligentTemplateConsultModel;
            }
