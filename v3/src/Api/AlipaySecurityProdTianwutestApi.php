...
/**
 * AlipaySecurityProdTianwutestApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipaySecurityProdTianwutestApi
{
    /**
     * @var ClientInterface
     */
     ...
     * tianwutest
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyModel $alipaySecurityProdTianwutestModifyModel alipaySecurityProdTianwutestModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyResponseModel|\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyDefaultResponse
     */
    public function modify($alipaySecurityProdTianwutestModifyModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->modifyWithHttpInfo($alipaySecurityProdTianwutestModifyModel, $customizedParams);
        return $response;
    }
     ...
     * tianwutest
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyModel $alipaySecurityProdTianwutestModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyResponseModel|\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyWithHttpInfo($alipaySecurityProdTianwutestModifyModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->modifyRequest($alipaySecurityProdTianwutestModifyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     */
    public function modifyAsync($alipaySecurityProdTianwutestModifyModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->modifyAsyncWithHttpInfo($alipaySecurityProdTianwutestModifyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function modifyAsyncWithHttpInfo($alipaySecurityProdTianwutestModifyModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipaySecurityProdTianwutestModifyResponseModel';
        $request = $this->modifyRequest($alipaySecurityProdTianwutestModifyModel, $customizedParams);
     ...
     */
    public function modifyRequest($alipaySecurityProdTianwutestModifyModel = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/security/prod/tianwutest/modify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipaySecurityProdTianwutestModifyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipaySecurityProdTianwutestModifyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipaySecurityProdTianwutestModifyModel;
            }
