...
/**
 * AlipayMarketingXuanyitestApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingXuanyitestApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 资源化测试4.0
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferModel $alipayMarketingXuanyitestTransferModel alipayMarketingXuanyitestTransferModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferDefaultResponse
     */
    public function transfer($alipayMarketingXuanyitestTransferModel = null, CustomizedParams $customizedParams = null)
    {
        list($response) = $this->transferWithHttpInfo($alipayMarketingXuanyitestTransferModel, $customizedParams);
        return $response;
    }
     ...
     * 资源化测试4.0
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferModel $alipayMarketingXuanyitestTransferModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function transferWithHttpInfo($alipayMarketingXuanyitestTransferModel = null, CustomizedParams $customizedParams = null)
    {
        $request = $this->transferRequest($alipayMarketingXuanyitestTransferModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     */
    public function transferAsync($alipayMarketingXuanyitestTransferModel = null, CustomizedParams $customizedParams = null)
    {
        return $this->transferAsyncWithHttpInfo($alipayMarketingXuanyitestTransferModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transferAsyncWithHttpInfo($alipayMarketingXuanyitestTransferModel = null, CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingXuanyitestTransferResponseModel';
        $request = $this->transferRequest($alipayMarketingXuanyitestTransferModel, $customizedParams);
     ...
     */
    public function transferRequest($alipayMarketingXuanyitestTransferModel = null, CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/marketing/xuanyitest/transfer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMarketingXuanyitestTransferModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMarketingXuanyitestTransferModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMarketingXuanyitestTransferModel;
            }
