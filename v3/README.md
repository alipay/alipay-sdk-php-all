...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/alipaysdk/openapi.git"
    }
  ],
  "require": {
...
*AlipayUserAgreementPermissionApi* | [**create**](docs/Api/AlipayUserAgreementPermissionApi.md#create) | **POST** /v3/alipay/user/agreement/permission/create | 支付宝协议支付许可创建接口
...
*KoubeiMemberDataIsvApi* | [**create**](docs/Api/KoubeiMemberDataIsvApi.md#create) | **POST** /v3/koubei/member/data/isv/create | isv 会员CRM数据回流
